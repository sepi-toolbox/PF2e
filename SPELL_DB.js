...
const SPELL_DB = [
  ...
  { name_ko: "차원 하인",
    ...
    desc: "<strong>사거리:</strong> 30피트<br><strong>지속 시간:</strong> 유지(최대 1분)<br>차원에서 하인을 소환합니다. 천상, 마귀, 또는 감시자를 소환하며, 주문 랭크에 따라 레벨이 결정됩니다. 소환된 생물은 하수인 특성을 가집니다." },
  ...
  { name_ko: "식물 형태",
    ...
    traits: ["조작","식물","변이"],
    duration: "1분",
    summary: "대형 식물 전투 형태로 변신합니다. AC = 19 + 레벨, 임시 HP 12, 독 저항 10, 미광 시각. 비무장 근접 공격 수정치 +17, 피해 보너스 +11(힘 기반). 운동 +19(자신이 더 높으면 그것을 사용).수목 형태: 속도 30피트, 가지(도달 15피트) 2d10 둔기, 발 2d8 둔기, 말할 수 있음.파리지옥 형태: 속도 15피트, 산성...",
    desc: "<strong>지속 시간:</strong> 1분<br>대형 식물 전투 형태로 변신합니다. AC = 19 + 레벨, 임시 HP 12, 독 저항 10, 미광 시각. 비무장 근접 공격 수정치 +17, 피해 보너스 +11(힘 기반). 운동 +19(자신이 더 높으면 그것을 사용).<br><strong>수목 형태:</strong> 속도 30피트, 가지(도달 15피트) 2d10 둔기, 발 2d8 둔기, 말할 수 있음.<br><strong>파리지옥 형태:</strong> 속도 15피트, 산성 저항 10, 잎(도달 10피트) 2d8 관통, 적중 후 잡힘(Grab).<br><strong>강화(6랭크):</strong> 거대, 공격 도달 +5피트, AC = 22 + 레벨, 임시 HP 24, 공격 수정치 +21, 피해 보너스 +16, 운동 +22." },
  ...
  { name_ko: "계절의 나무",
    ...
    range: "60피트",
    duration: "1분",
    summary: "작은 나무가 자라며 네 개의 씨앗 열매(각 계절)를 맺습니다. 생물이 상호작용(Interact)하여 열매를 딸 수 있습니다(30피트까지 같은 행동으로 던지거나 별도 상호작용으로 던짐). 던지면 5피트 폭발, 6d6 피해(기본 반사, 주문 DC). 피해 유형: 봄(전기), 여름(화염), 가을(독), 겨울(냉기). 주문 종료 시 나무 시들고 열매 썩음.강...",
    desc: "<strong>사거리:</strong> 60피트<br><strong>지속 시간:</strong> 1분<br>작은 나무가 자라며 네 개의 씨앗 열매(각 계절)를 맺습니다. 생물이 상호작용(Interact)하여 열매를 딸 수 있습니다(30피트까지 같은 행동으로 던지거나 별도 상호작용으로 던짐). 던지면 5피트 폭발, <strong>6d6 피해</strong>(기본 반사, 주문 DC). 피해 유형: 봄(전기), 여름(화염), 가을(독), 겨울(냉기). 주문 종료 시 나무 시들고 열매 썩음.<br><strong>강화(+1):</strong> 폭발 피해 +1d6." },
  ...
  { name_ko: "빙의",
    ...
    defense: "의지",
    duration: "1분",
    summary: "대상의 몸에 빙의합니다.성공: 동승(ride along) — 대상의 감각을 공유하지만 제어 불가.실패: 부분 제어 — 매 턴 시작 시 추가 의지 내성을 시도합니다.대실패: 완전 제어 — 대상은 꼭두각시가 됩니다.강화(9랭크): 지속 시간 10분, 물리적으로 대상의 몸에 들어갑니다.",
    desc: "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 살아있는 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 1분<br>대상의 몸에 빙의합니다.<br><strong>성공:</strong> 동승(ride along) — 대상의 감각을 공유하지만 제어 불가.<br><strong>실패:</strong> 부분 제어 — 매 턴 시작 시 추가 의지 내성을 시도합니다.<br><strong>대실패:</strong> 완전 제어 — 대상은 꼭두각시가 됩니다.<br><strong>강화(9랭크):</strong> 지속 시간 10분, 물리적으로 대상의 몸에 들어갑니다." },
  ...
  { name_ko: "징벌의 바람",
    ...
    duration: "유지(최대 1분)",
    summary: "강력한 바람이 영역을 휩씁니다. 비행 중인 생물은 40피트 하강합니다. 비행에 극심 험지. 지상/등반에 험지. 영역 내에서 턴을 끝내는 비행 생물은 20피트 하강합니다. 표면에 부딪히면 낙하 피해. 바깥쪽 수직 경계는 극심 험지이며, 비행 기동을 위해 운동 또는 곡예 판정이 필요합니다.",
    desc: "<strong>사거리:</strong> 100피트<br><strong>영역:</strong> 30피트 반경 100피트 높이 원통<br><strong>지속 시간:</strong> 유지(최대 1분)<br>강력한 바람이 영역을 휩씁니다. 비행 중인 생물은 40피트 하강합니다. 비행에 극심 험지. 지상/등반에 험지. 영역 내에서 턴을 끝내는 비행 생물은 20피트 하강합니다. 표면에 부딪히면 낙하 피해. 바깥쪽 수직 경계는 극심 험지이며, 비행 기동을 위해 운동 또는 곡예 판정이 필요합니다." },
  ...
  { name_ko: "불가해한 노래",
    ...
    defense: "의지",
    duration: "유지(최대 1분)",
    summary: "이상하고 부자연스러운 노래. 시전 시와 매 라운드 유지 시 의지 내성. 생물은 라운드당 1회만 내성. 유지 시 같은 대상 유지.대성공: 영향 없음, 이후 라운드 면역, 1분 일시적 면역. 성공: 이번 라운드 영향 없음, 이후 라운드 영향 가능. 실패: 1d4 굴림 — 1: 공포 2(1라운드), 2: 혼란(1라운드), 3: 멍청함 4(1라운드), 4: ...",
    desc: "<strong>사거리:</strong> 120피트<br><strong>대상:</strong> 최대 5 생물<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 유지(최대 1분)<br>이상하고 부자연스러운 노래. 시전 시와 매 라운드 유지 시 의지 내성. 생물은 라운드당 1회만 내성. 유지 시 같은 대상 유지.<br><strong>대성공:</strong> 영향 없음, 이후 라운드 면역, 1분 일시적 면역. <strong>성공:</strong> 이번 라운드 영향 없음, 이후 라운드 영향 가능. <strong>실패:</strong> 1d4 굴림 — 1: 공포 2(1라운드), 2: 혼란(1라운드), 3: 멍청함 4(1라운드), 4: 실명(1라운드). <strong>대실패:</strong> 1d4+1 굴림 — 5: 기절 1라운드+멍청함 1(무기한)." },
