...
(function (root) {
  ...
  async function loadAllowed() { if (_allowed) return _allowed; _allowed = _prepAllowed(await _fetchJSON(`${_dataRoot}/derived/allowed_content.json?v=0.304`)); return _allowed; }
  function _pubOf(d) {
