...
(function (root) {
  ...
  function loadFamiliarData() {
    ...
    return Promise.all([
      fetch('data/derived/familiar_progression.json?v=0.312').then(r => r.json()).then(_fillFamProg).catch(() => {}),
      fetch('data/derived/familiar_abilities.json?v=0.312').then(r => r.json()).then(j => _fillFamAbil(j.rows)).catch(() => {}),
    ]).then(() => {});
  }
  ...
  async function _ensureSubProfTable() {
    ...
    if (rows == null) { try { const r = await fetch("data/derived/subclass_progression.json?v=0.312"); rows = ((await r.json()).rows) || []; } catch (e) { rows = []; } }
  ...
  async function _ensureProfTable() {
    ...
    let rows = _profRows();
    if (rows == null) { try { const r = await fetch("data/derived/class_progression.json?v=0.312"); rows = ((await r.json()).rows) || []; } catch(e){ rows = []; } }
  ...
  function loadDoctrines() {
    ...
    return fetch('data/derived/cleric_doctrines.json?v=0.312').then(r => r.json()).then(j => { _injectDoctrines(j.rows); _doctrinesLoaded = true; }).catch(() => {});
  }
  ...
  function loadSubclasses() {
    ...
    return fetch('data/derived/subclasses.json?v=0.312').then(r => r.json()).then(j => { inject(j.rows); _subclassesLoaded = true; }).catch(() => {});
  }
  ...
  function loadBloodlines() {
    ...
    return fetch('data/derived/bloodlines.json?v=0.312').then(r => r.json()).then(j => { _fillBloodlineDB(j.rows); _fillBloodlineGuide(j.guide); _bloodlinesLoaded = true; }).catch(() => {});
  }
  ...
  function loadMysteries() {
    ...
    return fetch('data/derived/oracle_mysteries.json?v=0.312').then(r => r.json()).then(j => { _fillMysteryDB(j.rows); _fillMysteryGuide(j.guide); _mysteriesLoaded = true; }).catch(() => {});
  }
  ...
  function loadWizardSchools() {
    ...
    return fetch('data/derived/wizard_schools.json?v=0.312').then(r => r.json()).then(j => { _fillWizardSchoolDB(j.rows); _fillWizardSchoolGuide(j.guide); _wizardSchoolsLoaded = true; }).catch(() => {});
  }
  ...
  function loadBardMuses() {
    ...
    return fetch('data/derived/bard_muses.json?v=0.312').then(r => r.json()).then(j => { _fillBardMuseGuide(j.guide); _bardMusesLoaded = true; }).catch(() => {});
  }
  ...
  function loadWitchPatrons() {
    ...
    return fetch('data/derived/witch_patrons.json?v=0.312').then(r => r.json()).then(j => { _fillWitchPatronGuide(j.guide); _witchPatronsLoaded = true; }).catch(() => {});
  }
  ...
  function loadDruidOrders() {
    ...
    return fetch('data/derived/druid_orders.json?v=0.312').then(r => r.json()).then(j => { _fillDruidOrderGuide(j.guide); _druidOrdersLoaded = true; }).catch(() => {});
  }
  ...
  function loadRangerEdges() {
    ...
    return fetch('data/derived/ranger_edges.json?v=0.312').then(r => r.json()).then(j => { _fillRangerEdgeGuide(j.guide); _rangerEdgesLoaded = true; }).catch(() => {});
  }
  ...
  function loadRogueRackets() {
    ...
    return fetch('data/derived/rogue_rackets.json?v=0.312').then(r => r.json()).then(j => { _fillRogueRacketGuide(j.guide); _rogueRacketsLoaded = true; }).catch(() => {});
  }
  ...
  function loadChampionCauses() {
    ...
    return fetch('data/derived/champion_causes.json?v=0.312').then(r => r.json()).then(j => { _fillChampionCauseGuide(j.guide); _championCausesLoaded = true; }).catch(() => {});
  }
  ...
  function loadBarbarianInstincts() {
    ...
    return fetch('data/derived/barbarian_instincts.json?v=0.312').then(r => r.json()).then(j => { _fillBarbarianInstinctGuide(j.guide); _barbarianInstinctsLoaded = true; }).catch(() => {});
  }
  ...
  function loadInvestigatorMethodologies() {
    ...
    return fetch('data/derived/investigator_methodologies.json?v=0.312').then(r => r.json()).then(j => { _fillInvestigatorMethodologyGuide(j.guide); _investigatorMethodologiesLoaded = true; }).catch(() => {});
  }
  ...
  function loadSwashbucklerStyles() {
    ...
    return fetch('data/derived/swashbuckler_styles.json?v=0.312').then(r => r.json()).then(j => { _fillSwashbucklerStyleGuide(j.guide); _swashbucklerStylesLoaded = true; }).catch(() => {});
  }
  ...
  function loadAlchemistResearchFields() {
    ...
    return fetch('data/derived/alchemist_research_fields.json?v=0.312').then(r => r.json()).then(j => { _fillAlchemistResearchFieldGuide(j.guide); _alchemistResearchFieldsLoaded = true; }).catch(() => {});
  }
  ...
  function loadFighterFeatures() {
    ...
    return fetch('data/derived/fighter_features.json?v=0.312').then(r => r.json()).then(j => { _fillFighterGuide(j.guide); _fighterFeaturesLoaded = true; }).catch(() => {});
  }
  ...
  function loadMonkFeatures() {
    ...
    return fetch('data/derived/monk_features.json?v=0.312').then(r => r.json()).then(j => { _fillMonkGuide(j.guide); _monkFeaturesLoaded = true; }).catch(() => {});
  }
