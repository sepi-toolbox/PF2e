...
var DEITY_DB = [
  ...
  },
  {
    ...
    "title": "죽음의 여인",
    "desc": "대부분의 다른 신들보다 고대하고 강력하며, 뼈의 정원의 옥좌에서 죽은 모든 이의 영혼을 심판합니다. 출생과 죽음의 자연적 순환이 방해받지 않도록 합니다.<br><b>관심 영역:</b> 출생, 죽음, 운명, 예언, 시간<br><b>계율:</b> 고대 예언을 이해하려 노력하라, 언데드를 파괴하라, 시신을 안식시켜라"
  },
  {
    "id": "rovagug",
    "name_ko": "로바구그",
