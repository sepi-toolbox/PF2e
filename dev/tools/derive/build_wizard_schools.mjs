...
const guide = [
  ...
  { term: '교육과정(커리큘럼)', def: '학파가 나열한 주문을 주문서에 추가합니다. 또한 각 주문 랭크마다 보너스 준비 슬롯(커리큘럼 캔트립 1개·주문 1개)을 얻으며, 그 슬롯은 학파 커리큘럼 주문으로만 준비할 수 있습니다.' },
  { term: '학파 주문', def: '학파가 부여하는 포커스 주문입니다. 1레벨에 초급 학파 주문을 얻고, 「고급 학파 주문」 재주로 상급 학파 주문을 추가로 얻습니다. 포커스 포인트로 시전하고 재집중으로 회복합니다.' },
