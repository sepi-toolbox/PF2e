...
const SPELL_DB = [
  ...
  },
  {
    ...
    "desc": "<strong>영역:</strong> 60피트 발산<br><strong>지속 시간:</strong> 1라운드<br>말이나 격려의 노래로 자신과 아군에게 영감을 줍니다. 당신과 영역 내 모든 아군은 명중 굴림, 피해 굴림, {{condition:Frightened}} 효과에 대한 내성에 <strong>+1 상태 보너스</strong>를 얻습니다."
  },
  {
    "id": "daze",
    "name_ko": "멍하게",
    ...
    "defense": "의지",
    "duration": "1라운드",
    "summary": "대상의 정신을 흐리게 하여 무방비하거나 둔화시킵니다.대성공: 영향 없음.성공: 대상이 1라운드간 무방비.실패: 대상이 4 정신 피해를 받고 1라운드간 무방비.대실패: 대상이 4 정신 피해를 받고 1라운드간 무방비 + 둔화 1(slowed 1).강화(+2): 피해 +4.",
    "desc": "<strong>사거리:</strong> 60피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 1라운드<br>대상의 정신을 흐리게 하여 무방비하거나 둔화시킵니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> 대상이 1라운드간 <strong>{{condition:Off-Guard}}</strong>.<br><strong>실패:</strong> 대상이 <strong>4 정신 피해</strong>를 받고 1라운드간 <strong>{{condition:Off-Guard}}</strong>.<br><strong>대실패:</strong> 대상이 <strong>4 정신 피해</strong>를 받고 1라운드간 <strong>{{condition:Off-Guard}} + {{condition:Slowed}} 1(slowed 1)</strong>.<br><strong>강화(+2):</strong> 피해 +4."
  },
  {
    "id": "detect-magic",
    "name_ko": "마법 탐지",
  ...
  },
  {
    ...
    "range": "60피트",
    "target": "생물 1",
    "summary": "신성 에너지를 던져 1d4 영혼 피해를 가합니다. 신성 성별화를 가지고 있으면 불경 대상에 추가 1d4 피해. 불경 성별화를 가지면 신성 대상에 추가 1d4 피해. 성별화가 없으면 양쪽 모두에 추가 피해 가능.강화(+1): 피해 +1d4, 추가 피해 +1d4.",
    "desc": "<strong>사거리:</strong> 60피트<br><strong>대상:</strong> 생물 1<br>신성 에너지를 던져 <strong>1d4 영혼 피해</strong>를 가합니다. 신성 성별화를 가지고 있으면 불경 대상에 추가 1d4 피해. 불경 성별화를 가지면 신성 대상에 추가 1d4 피해. 성별화가 없으면 양쪽 모두에 추가 피해 가능.<br><strong>강화(+1):</strong> 피해 +1d4, 추가 피해 +1d4."
  },
  {
    "id": "electric-arc",
    "name_ko": "전기 호",
  ...
  },
  {
    ...
    "defense": "의지",
    "duration": "1라운드",
    "summary": "저주의 눈으로 적을 응시합니다. 의지 실패 시 대상이 공포 1. 대실패 시 공포 2. 면역을 무시합니다.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 1라운드<br>저주의 눈으로 적을 응시합니다. 의지 실패 시 대상이 <strong>{{condition:Frightened}} 1</strong>. 대실패 시 {{condition:Frightened}} 2. 면역을 무시합니다."
  },
  {
    "id": "figment",
    "name_ko": "허상",
    ...
    "range": "30피트",
    "duration": "유지(최대 1분)",
    "summary": "간단한 환영 소리 또는 시각 이미지를 만듭니다. 소리를 선택하면 청각 특성이 추가되며, 알아들을 수 있는 말이나 정교한 음악은 포함할 수 없습니다. 이미지를 선택하면 최대 5피트 정육면체 크기이며, 15피트 이내에서는 명백히 조잡하게 보입니다. 시전하거나 유지할 때, 기만 판정에 +2 상황 보너스를 받아 주의 끌기를...",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>지속 시간:</strong> 유지(최대 1분)<br>간단한 환영 소리 또는 시각 이미지를 만듭니다. 소리를 선택하면 청각 특성이 추가되며, 알아들을 수 있는 말이나 정교한 음악은 포함할 수 없습니다. 이미지를 선택하면 최대 5피트 정육면체 크기이며, 15피트 이내에서는 명백히 조잡하게 보입니다. 시전하거나 유지할 때, 기만 판정에 <strong>+2 상황 보너스</strong>를 받아 주의 끌기를 시도할 수 있습니다."
  },
  {
    "id": "forbidding-ward",
    "name_ko": "금지의 수호",
  ...
  },
  {
    ...
    "target": "물체 1(1 부피 이하)",
    "duration": "유지",
    "summary": "사소한 마법 트릭을 수행합니다. 네 가지 옵션 중 하나를 선택합니다: 요리 — 음식을 데우거나 식힘; 들기 — 1 부피 이하 물체를 천천히 이동(부양은 아님); 만들기 — 작은 물체를 일시적으로 만듦; 정리 — 표면의 먼지나 때를 제거.강화(+2): 최대 유지 시간이 10분으로 증가.",
    "desc": "<strong>사거리:</strong> 10피트<br><strong>대상:</strong> 물체 1(1 부피 이하)<br><strong>지속 시간:</strong> 유지<br>사소한 마법 트릭을 수행합니다. 네 가지 옵션 중 하나를 선택합니다: <strong>요리</strong> — 음식을 데우거나 식힘; <strong>들기</strong> — 1 부피 이하 물체를 천천히 이동(부양은 아님); <strong>만들기</strong> — 작은 물체를 일시적으로 만듦; <strong>정리</strong> — 표면의 먼지나 때를 제거.<br><strong>강화(+2):</strong> 최대 유지 시간이 10분으로 증가."
  },
  {
    "id": "shield",
    "name_ko": "방패",
    ...
    "duration": "다음 턴 시작까지",
    "summary": "마법의 힘으로 된 방패를 만듭니다. 다음 턴 시작까지 AC에 +1 상황 보너스를 얻습니다. 방패 막기 반응이 있으면, 이 마법 방패로도 사용할 수 있습니다. 경도 5이며, 이 방식으로 피해를 받으면 주문이 종료되고 10분간 방패를 다시 시전할 수 없습니다.강화(3랭크): 경도 10.강화(5랭크): 경도 15.강화(7랭크): 경...",
  ...
  },
  {
    ...
    "defense": "의지",
    "duration": "1라운드",
    "summary": "어둠의 장막으로 적의 시야를 방해합니다. 의지 실패 시 대상이 현혹됨(1라운드). 대실패 시 현혹됨(1분).",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 1라운드<br>어둠의 장막으로 적의 시야를 방해합니다. 의지 실패 시 대상이 <strong>{{condition:Dazzled}}</strong>(1라운드). 대실패 시 {{condition:Dazzled}}(1분)."
  },
  {
    "id": "sigil",
    "name_ko": "인장",
  ...
  },
  {
    ...
    "area": "60피트 발산",
    "duration": "1라운드",
    "summary": "뮤즈: 전사힘찬 격려로 아군의 물리적 힘을 북돋웁니다. 당신과 아군은 운동 판정과, 무장 해제, 재배치, 밀기, 넘어뜨리기 같은 운동 기술 행동에 대한 DC에 +1 상태 보너스를 얻습니다.",
    "desc": "<strong>영역:</strong> 60피트 발산<br><strong>지속 시간:</strong> 1라운드<br><strong>뮤즈:</strong> 전사<br>힘찬 격려로 아군의 물리적 힘을 북돋웁니다. 당신과 아군은 운동 판정과, 무장 해제, 재배치, 밀기, 넘어뜨리기 같은 운동 기술 행동에 대한 DC에 <strong>+1 상태 보너스</strong>를 얻습니다."
  },
  {
    "id": "stabilize",
    "name_ko": "안정",
    ...
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> {{condition:Dying}} 상태의 생물 1<br>대상이 {{condition:Dying}} 상태를 잃지만 0 HP에서 무의식 상태로 남습니다."
  },
  {
    "id": "stoke-the-heart",
    "name_ko": "심장 격려",
  ...
  },
  {
    ...
    "duration": "1시간",
    "summary": "손에 들 수 있는 악기 하나를 물질화합니다. 해당 유형에 전형적인 악기입니다. 다시 시전하면 이전 악기가 사라집니다.강화(5랭크): 명인용 손에 든 악기.",
    "desc": "<strong>지속 시간:</strong> 1시간<br>손에 들 수 있는 악기 하나를 물질화합니다. 해당 유형에 전형적인 악기입니다. 다시 시전하면 이전 악기가 사라집니다.<br><strong>강화(5랭크):</strong> 명인용 손에 든 악기."
  },
  {
    "id": "tangle-vine",
    "name_ko": "덩굴 묶기",
    ...
    "target": "생물 1",
    "defense": "AC",
    "summary": "덩굴을 소환하여 적을 얽어맵니다. 주문 명중 굴림을 합니다.대성공: 대상은 이동 불가가 되고 이동 속도에 -10피트 상황 페널티를 받습니다(1라운드). 주문 DC에 대해 탈출 가능.성공: 이동 속도에 -10피트 상황 페널티(1라운드). 탈출 가능.실패: 영향 없음.강화(2랭크): 효과가 2라운드 지속.강화(4랭크): 효과가 1분...",
  ...
  },
  {
    ...
    "target": "아군 1",
    "duration": "1라운드",
    "summary": "뮤즈: 마에스트로연주로 아군이 무엇이든 성공할 수 있다는 느낌을 줍니다. 이것은 당신이 선택한 기술 판정에 대해 아군을 지원 준비한 것으로 간주됩니다. 이후 지원 반응을 사용할 때 일반 기술 판정 대신 공연을 굴릴 수 있으며, 실패를 굴려도 성공으로 취급합니다. 공연이 전설이면 자동으로 대성공입...",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 아군 1<br><strong>지속 시간:</strong> 1라운드<br><strong>뮤즈:</strong> 마에스트로<br>연주로 아군이 무엇이든 성공할 수 있다는 느낌을 줍니다. 이것은 당신이 선택한 기술 판정에 대해 아군을 <strong>지원 준비</strong>한 것으로 간주됩니다. 이후 지원 반응을 사용할 때 일반 기술 판정 대신 <strong>공연</strong>을 굴릴 수 있으며, 실패를 굴려도 <strong>성공으로 취급</strong>합니다. 공연이 전설이면 <strong>자동으로 대성공</strong>입니다.<br>GM은 아군을 격려하는 행위가 기술 판정과 간섭할 경우(조용히 은신하거나 변장을 유지하는 등) 이 능력을 사용할 수 없다고 판정할 수 있습니다."
  },
  {
    "id": "vitality-lash",
    "name_ko": "활력 채찍",
    ...
    "defense": "기본 인내",
    "summary": "활력 에너지로 채찍질합니다. 2d6 활력 피해(기본 인내). 대실패 시 다음 턴 시작까지 약화 1도 받습니다.강화(+1): 피해 +1d6.",
  ...
  },
  {
    ...
    "target": "살아있는 생물 1",
    "defense": "기본 인내",
    "summary": "공허 에너지로 산 것을 피해입히고 약화시킵니다. 2d4 공허 피해(기본 인내). 대실패 시 다음 턴 시작까지 약화 1도 받습니다.강화(+1): 피해 +1d4.",
  ...
  },
  {
    ...
    "area": "30피트 발산",
    "duration": "1라운드",
    "summary": "영역 내 적은 공포 1이 됩니다. 영역 내에 남아 있는 동안 공포 수치를 1 미만으로 줄일 수 없습니다.",
    "desc": "<strong>영역:</strong> 30피트 발산<br><strong>지속 시간:</strong> 1라운드<br>영역 내 적은 <strong>{{condition:Frightened}} 1</strong>이 됩니다. 영역 내에 남아 있는 동안 {{condition:Frightened}} 수치를 <strong>1 미만으로 줄일 수 없습니다</strong>."
  },
  {
    "id": "song-of-marching",
    "name_ko": "행군의 노래",
    ...
    "area": "60피트 발산",
    "duration": "유지(최대 1시간)",
    "summary": "아군의 이동을 유지하는 경쾌한 연주를 합니다. 당신과 영역 내 아군은 주문 지속 시간 동안 다른 탐험 활동에 추가하여 급행군을 할 수 있습니다(당신의 탐험 활동은 이 주문의 유지입니다). 이후 당신과 아군은 1일간 일시 면역이 됩니다.이 노래를 연주하는 중에 전투에 돌입하면, 우선권 굴림에 공연 수정치를 사용할 수 있습니다. 당신과 영향...",
    "desc": "<strong>영역:</strong> 60피트 발산<br><strong>지속 시간:</strong> 유지(최대 1시간)<br>아군의 이동을 유지하는 경쾌한 연주를 합니다. 당신과 영역 내 아군은 주문 지속 시간 동안 다른 탐험 활동에 추가하여 <strong>급행군</strong>을 할 수 있습니다(당신의 탐험 활동은 이 주문의 유지입니다). 이후 당신과 아군은 <strong>1일간 일시 면역</strong>이 됩니다.<br>이 노래를 연주하는 중에 전투에 돌입하면, 우선권 굴림에 <strong>공연 수정치</strong>를 사용할 수 있습니다. 당신과 영향받은 아군은 해당 우선권 굴림에 <strong>+1 상태 보너스</strong>도 받습니다.<br><strong>강화(6랭크):</strong> 최대 2시간까지 유지 가능.<br><strong>강화(9랭크):</strong> 최대 4시간까지 유지 가능."
  },
  {
  ...
  },
  {
    ...
    "target": "아군 1",
    "duration": "1라운드",
    "summary": "빠르게 연주하여 아군의 속도를 높입니다. 대상은 가속 상태가 되어 추가 행동을 얻으며, 이 추가 행동은 타격, 보폭, 또는 걸음에만 사용할 수 있습니다.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 아군 1<br><strong>지속 시간:</strong> 1라운드<br>빠르게 연주하여 아군의 속도를 높입니다. 대상은 <strong>{{condition:Quickened}}</strong> 상태가 되어 추가 행동을 얻으며, 이 추가 행동은 <strong>타격, 보폭, 또는 걸음</strong>에만 사용할 수 있습니다."
  },
  {
    "id": "agile-feet",
    "name_ko": "민첩한 발",
    ...
    "duration": "현재 턴 종료까지",
    "summary": "신의 축복이 발을 빠르게 합니다. 이동 속도에 +5피트 상태 보너스+험지 무시. 시전의 일부로 한 걸음/보폭/통과 가능. 적절한 속도가 있으면 굴파기/등반/비행/수영도 가능.",
    "desc": "<strong>지속 시간:</strong> 현재 턴 종료까지<br>신의 축복이 발을 빠르게 합니다. 이동 속도에 <strong>+5피트 상태 보너스</strong>+<strong>험지 무시</strong>. 시전의 일부로 한 걸음/보폭/통과 가능. 적절한 속도가 있으면 굴파기/등반/비행/수영도 가능."
  },
  {
    "id": "athletic-rush",
    "name_ko": "운동 돌진",
  ...
  },
  {
    ...
    "summary": "악랄한 웃음으로 유지 중인 주문을 자유 행동으로 유지합니다. 이번 턴에 유지 행동 대신 이것을 사용하여 1개의 주문을 유지할 수 있습니다.",
    "desc": "악랄한 웃음으로 유지 중인 주문을 자유 행동으로 유지합니다. 이번 턴에 유지 행동 대신 이것을 사용하여 1개의 주문을 유지할 수 있습니다."
  },
  {
    "id": "charming-push",
    "name_ko": "매혹의 밀침",
    ...
    "defense": "의지",
    "duration": "다음 턴 시작까지",
    "summary": "대상의 마음을 밀어 적의를 꺾습니다. 대상은 의지 내성을 시도합니다.대성공: 영향 없음.성공: 대상은 당신에 대한 명중 굴림과 피해 굴림에 -1 상황 페널티를 받습니다.실패: 대상은 당신에 대해 적대적 행동을 사용할 수 없습니다.대실패: 대상은 기절 1이 되고 당신에 대해 적대적 행동을 사용할 수 없습니다.",
  ...
  },
  {
    ...
    "target": "동의 생물 1",
    "duration": "1분",
    "summary": "대상을 소용돌이치는 그림자의 망토로 감쌉니다. 대상을 보기 어렵게 만듭니다. 망토는 20피트 발산 내의 밝은 빛을 희미한 빛으로 줄입니다. 이것은 마법적 어둠의 한 형태이므로 431페이지에 설명된 대로 비마법적 빛을 극복하거나 마법적 빛을 상쇄할 수 있습니다.대상은 그림자에서 얻은 은폐 상태를 사용하여 숨기를 할 수 있지...",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 동의 생물 1<br><strong>지속 시간:</strong> 1분<br>대상을 소용돌이치는 그림자의 망토로 감쌉니다. 대상을 보기 어렵게 만듭니다. 망토는 20피트 발산 내의 밝은 빛을 희미한 빛으로 줄입니다. 이것은 마법적 어둠의 한 형태이므로 431페이지에 설명된 대로 비마법적 빛을 극복하거나 마법적 빛을 상쇄할 수 있습니다.<br>대상은 그림자에서 얻은 {{condition:Concealed}} 상태를 사용하여 숨기를 할 수 있지만, 주의 깊은 관찰자는 여전히 움직이는 그림자 기운을 따라갈 수 있어 완전히 미탐지 상태가 되기는 어렵습니다. 대상은 상호작용 행동으로 망토를 벗어 미끼로 남겨둘 수 있으며, 망토는 남은 주문 지속 시간 동안 빛을 줄입니다. 망토가 벗겨진 후 누군가 주우면 원래 대상에게서 제거된 것이므로 망토는 증발하고 주문이 종료됩니다."
  },
  {
    "id": "cornucopia",
    "name_ko": "축제의 뿔피리",
  ...
  },
  {
    ...
    "summary": "공연으로 당신과 아군을 보호합니다. 알고 있는 유형의 공연 판정을 굴립니다 — 유발 조건이 청각이면 청각 공연, 시각이면 시각 공연이어야 하며, 이 행동은 해당 공연 유형의 특성을 얻습니다. 당신과 영역 내 아군은 공연 판정 결과와 내성 굴림 중 더 좋은 결과를 사용할 수 있습니다.",
    "desc": "<strong>영역:</strong> 60피트 발산<br><strong>유발 조건:</strong> 당신 또는 60피트 이내 아군이 청각 또는 시각 효과에 대한 내성 굴림을 시도할 때<br>공연으로 당신과 아군을 보호합니다. 알고 있는 유형의 공연 판정을 굴립니다 — 유발 조건이 청각이면 청각 공연, 시각이면 시각 공연이어야 하며, 이 행동은 해당 공연 유형의 특성을 얻습니다. 당신과 영역 내 아군은 공연 판정 결과와 내성 굴림 중 <strong>더 좋은 결과</strong>를 사용할 수 있습니다."
  },
  {
    "id": "creative-splash",
    "name_ko": "창의적 물감",
    ...
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br>당신의 개인적 창작 전문 분야를 반영하는 물감이나 다채로운 환영의 홍수가 영역에 쏟아집니다. 1d4를 굴려 환영의 색을 결정합니다. 영역 내 각 생물은 의지 내성에 성공하거나, 해당 색의 효과를 받아야 합니다.<br><strong>1 하양:</strong> 실패 시 {{condition:Dazzled}} 1라운드 / 대실패 시 {{condition:Dazzled}} 1분.<br><strong>2 빨강:</strong> 실패 시 {{condition:Enfeebled}} 1 (1라운드) / 대실패 시 {{condition:Enfeebled}} 2 (1라운드).<br><strong>3 노랑:</strong> 실패 시 {{condition:Frightened}} 1 / 대실패 시 {{condition:Frightened}} 2.<br><strong>4 파랑:</strong> 실패 시 {{condition:Clumsy}} 1 (1라운드) / 대실패 시 {{condition:Clumsy}} 2 (1라운드)."
  },
  {
    ...
    "area": "15피트 원뿔",
    "defense": "기본 인내",
    "summary": "목소리가 쿵 울려 앞에 있는 것을 부수어 버립니다. 영역 내 각 생물과 주인 없는 물체는 1d8 음파 피해를 받습니다(기본 인내). 이 턴에 이미 타격이나 주문으로 적에게 피해를 준 적이 있다면, 이 주문의 피해 주사위가 d12로 증가합니다.강화(+1): 피해 +1d8.",
    "desc": "<strong>영역:</strong> 15피트 원뿔<br><strong>방어:</strong> 기본 인내<br>목소리가 쿵 울려 앞에 있는 것을 부수어 버립니다. 영역 내 각 생물과 주인 없는 물체는 <strong>1d8 음파 피해</strong>를 받습니다(기본 인내). 이 턴에 이미 타격이나 주문으로 적에게 피해를 준 적이 있다면, 이 주문의 피해 주사위가 <strong>d12</strong>로 증가합니다.<br><strong>강화(+1):</strong> 피해 +1d8."
  },
  {
    "id": "dazzling-flash",
    "name_ko": "눈부신 섬광",
    ...
    "desc": "<strong>영역:</strong> 15피트 원뿔<br><strong>방어:</strong> 인내<br>종교 상징을 들어올려 눈부신 빛의 섬광을 만듭니다.<br><strong>대성공:</strong> 영향 없음. <strong>성공:</strong> {{condition:Dazzled}} 1라운드. <strong>실패:</strong> {{condition:Blinded}} 1라운드+{{condition:Dazzled}} 1분. <strong>대실패:</strong> {{condition:Blinded}} 1라운드+{{condition:Dazzled}} 1시간.<br><strong>강화(3랭크):</strong> 영역 30피트 원뿔."
  },
  {
    "id": "deaths-call",
    "name_ko": "죽음의 부름",
  ...
  },
  {
    ...
    "range": "30피트",
    "target": "생물 또는 물체 1",
    "summary": "마법 힘의 화살을 발사합니다. 1d4+1 힘 피해(자동 명중). 힘의 포격과 유사하지만 1발만.강화(+2): 피해 +1d4+1.",
  ...
  },
  {
    ...
    "summary": "뮤즈: 마에스트로작곡에 장식을 추가하여 효과를 연장합니다. 다음 행동이 지속 시간 1라운드인 작곡 캔트립 시전이라면, 공연 판정을 시도합니다. DC는 보통 작곡 대상 중 가장 높은 레벨과 동일한 표준 난이도 DC이지만, GM이 상황에 따라 다른 DC를 지정할 수 있습니다. 효과는 판정 결과에 따라 달라집니다.대성...",
    "desc": "<strong>뮤즈:</strong> 마에스트로<br>작곡에 장식을 추가하여 효과를 연장합니다. 다음 행동이 지속 시간 1라운드인 작곡 캔트립 시전이라면, 공연 판정을 시도합니다. DC는 보통 작곡 대상 중 가장 높은 레벨과 동일한 표준 난이도 DC이지만, GM이 상황에 따라 다른 DC를 지정할 수 있습니다. 효과는 판정 결과에 따라 달라집니다.<br><strong>대성공:</strong> 작곡이 <strong>4라운드</strong> 동안 지속됩니다.<br><strong>성공:</strong> 작곡이 <strong>3라운드</strong> 동안 지속됩니다.<br><strong>실패:</strong> 작곡이 1라운드 동안 지속되지만(정상), 이 주문에 집중점을 소비하지 않습니다."
  },
  {
    ...
    "range": "30피트",
    "target": "당신 또는 유발 아군",
    "trigger": "사거리 내 당신 또는 아군이 지식 회상 기술 판정을 시도할 때",
    "summary": "뮤즈: 수수께끼뮤즈의 깊은 신비에 호소하여, 대상에게 더 뛰어난 사고력과 정보 회상 능력을 부여합니다. 유발된 지식 회상 기술 판정을 두 번 굴려 높은 결과를 사용합니다.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 당신 또는 유발 아군<br><strong>유발 조건:</strong> 사거리 내 당신 또는 아군이 지식 회상 기술 판정을 시도할 때<br><strong>뮤즈:</strong> 수수께끼<br>뮤즈의 깊은 신비에 호소하여, 대상에게 더 뛰어난 사고력과 정보 회상 능력을 부여합니다. 유발된 지식 회상 기술 판정을 <strong>두 번 굴려 높은 결과</strong>를 사용합니다."
  },
  {
    "id": "magic-hide",
    "name_ko": "마법 독",
  ...
  },
  {
    ...
    "target": "생물 1",
    "duration": "유지(최대 1분)",
    "summary": "생물이 순수한 마법 에너지의 신성한 그릇이 됩니다. 대상은 내성 굴림에 +1 상태 보너스를 얻습니다. 당신이 주문 슬롯에서 주문을 시전할 때마다, 이 주문을 자동으로 유지하고 대상에게 시전한 주문의 랭크와 동일한 주문 피해 저항을 부여합니다. 이 저항은 당신의 다음 턴 시작까지 지속됩니다.",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 생물 1<br><strong>지속 시간:</strong> 유지(최대 1분)<br>생물이 순수한 마법 에너지의 신성한 그릇이 됩니다. 대상은 내성 굴림에 <strong>+1 상태 보너스</strong>를 얻습니다. 당신이 주문 슬롯에서 주문을 시전할 때마다, 이 주문을 자동으로 유지하고 대상에게 시전한 주문의 랭크와 동일한 <strong>주문 피해 저항</strong>을 부여합니다. 이 저항은 당신의 다음 턴 시작까지 지속됩니다."
  },
  {
    "id": "moonbeam",
    "name_ko": "달빛",
    ...
    "desc": "<strong>사거리:</strong> 120피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 반사<br>달빛 광선을 발사합니다. 주문 명중 굴림을 합니다. 광선은 <strong>2d6 화염 피해</strong>를 줍니다. 이 피해는 약점, 저항 등의 목적에서 <strong>은 피해</strong>로 취급됩니다.<br><strong>대성공:</strong> 2배 피해, 대상이 <strong>1분</strong> 동안 {{condition:Dazzled}}.<br><strong>성공:</strong> 전체 피해, 대상이 <strong>1라운드</strong> 동안 {{condition:Dazzled}}.<br><strong>강화(+1):</strong> 피해 +1d6."
  },
  {
  ...
  },
  {
    ...
    "target": "생물 1",
    "defense": "인내",
    "summary": "음식으로 과식시킵니다. 인내 실패 시 메스꺼움 1. 대실패 시 메스꺼움 2. 이 메스꺼움의 인내 판정에 -2.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 인내<br>음식으로 과식시킵니다. 인내 실패 시 <strong>{{condition:Sickened}} 1</strong>. 대실패 시 {{condition:Sickened}} 2. 이 메스꺼움의 인내 판정에 -2."
  },
  {
    "id": "perfected-mind",
    "name_ko": "완벽한 정신",
  ...
  },
  {
    ...
    "area": "시전자 중심 5피트 발산",
    "duration": "유지(최대 1분)",
    "summary": "문자 고리를 펼쳐 아군을 보호합니다. 당신과 영역 내 아군은 AC에 +1 상태 보너스를 받습니다. 매 턴 주문을 유지할 때마다 발산 반경이 5피트씩 증가하며, 최대 30피트까지 확장됩니다.",
    "desc": "<strong>영역:</strong> 시전자 중심 5피트 발산<br><strong>지속 시간:</strong> 유지(최대 1분)<br>문자 고리를 펼쳐 아군을 보호합니다. 당신과 영역 내 아군은 <strong>AC에 +1 상태 보너스</strong>를 받습니다. 매 턴 주문을 유지할 때마다 발산 반경이 5피트씩 증가하며, 최대 30피트까지 확장됩니다."
  },
  {
    "id": "pushing-gust",
    "name_ko": "밀어내는 돌풍",
  ...
  },
  {
    ...
    "target": "생물 1",
    "defense": "인내",
    "summary": "공허 에너지로 대상의 몸을 뒤섞습니다. 1d4 공허 피해. 인내 실패 시 서투름 1(1라운드). 대실패 시 서투름 2.강화(+1): 피해 +1d4.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 인내<br>공허 에너지로 대상의 몸을 뒤섞습니다. <strong>1d4 공허 피해</strong>. 인내 실패 시 <strong>{{condition:Clumsy}} 1</strong>(1라운드). 대실패 시 {{condition:Clumsy}} 2.<br><strong>강화(+1):</strong> 피해 +1d4."
  },
  {
    "id": "soothing-words",
    "name_ko": "달래는 말",
    ...
    "target": "동의 생물 1",
    "duration": "1라운드",
    "summary": "달래는 말로 안정시킵니다. 대상이 공포 상태이면 공포 수치를 1 감소. 또한 정신 효과에 대한 다음 내성에 +1 상태 보너스.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 동의 생물 1<br><strong>지속 시간:</strong> 1라운드<br>달래는 말로 안정시킵니다. 대상이 {{condition:Frightened}} 상태이면 <strong>{{condition:Frightened}} 수치를 1 감소</strong>. 또한 정신 효과에 대한 다음 내성에 +1 상태 보너스."
  },
  {
    "id": "sudden-shift",
    "name_ko": "돌발 전환",
    ...
    "summary": "위험한 곳에서 재빨리 벗어나며 자신을 숨깁니다. 한 걸음을 밟고 은폐 상태가 됩니다.",
    "desc": "<strong>지속 시간:</strong> 다음 턴 끝까지<br><strong>유발 조건:</strong> 적이 근접 공격에 빗나감<br>위험한 곳에서 재빨리 벗어나며 자신을 숨깁니다. 한 걸음을 밟고 <strong>{{condition:Concealed}}</strong> 상태가 됩니다."
  },
  {
    "id": "sweet-dream",
    "name_ko": "달콤한 꿈",
  ...
  },
  {
    ...
    "target": "생물 1",
    "defense": "반사",
    "summary": "번개를 소환하여 적에게 1d12 전기 피해. 실패 시 피해+서투름 2(1라운드). 대실패 시 2배 피해+서투름 2.강화(+1): 피해 +1d12.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 반사<br>번개를 소환하여 적에게 <strong>1d12 전기 피해</strong>. 실패 시 피해+<strong>{{condition:Clumsy}} 2</strong>(1라운드). 대실패 시 2배 피해+{{condition:Clumsy}} 2.<br><strong>강화(+1):</strong> 피해 +1d12."
  },
  {
    "id": "tidal-surge",
    "name_ko": "조류 파도",
  ...
  },
  {
    ...
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 살아있는 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 다양<br>의지력을 침식합니다. <strong>성공:</strong> {{condition:Stupefied}} 1(다음 턴 끝까지). <strong>실패:</strong> {{condition:Stupefied}} 2. <strong>대실패:</strong> {{condition:Stupefied}} 2(1분)+넘어뜨려짐."
  },
  {
    "id": "touch-of-undeath",
    "name_ko": "언데드의 접촉",
    ...
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 살아있는 생물 1<br><strong>방어:</strong> 인내<br><strong>지속 시간:</strong> 다양<br>언데드의 힘으로 공격합니다. <strong>1d6 공허 피해</strong>. 인내 실패 시 <strong>{{condition:Enfeebled}} 1</strong>(1라운드). 대실패 시 {{condition:Enfeebled}} 2.<br><strong>강화(+1):</strong> 피해 +1d6."
  },
  {
    "id": "unimpeded-stride",
    "name_ko": "방해 없는 보폭",
  ...
  },
  {
    ...
    "duration": "1라운드",
    "summary": "자신의 내면에서 다른 부분을 찾아 해방시켜 몸을 다른 형태로 변화시킵니다. 해충 형태에 나열된 어떤 형태로든 변이할 수 있으며, 이 형태는 10분 동안 지속됩니다. 그 외의 야생 해방 형태는 1분 동안 지속됩니다. 드루이드 재주를 통해 야생 해방 목록에 더 많은 형태를 추가할 수 있습니다. 사용 가능한 재주에 따라 접근할 수 있는 ...",
  ...
  },
  {
    ...
    "duration": "1분",
    "summary": "자신감으로 자신을 감쌉니다. 현재 공포 수치를 1 감소시키고, 지속 시간 동안 공포 상태가 될 때마다 그 수치를 1 감소시킵니다. 공포 효과에 대해 대실패를 하면, 자신감의 장막이 해당 효과의 공포 수치를 줄인 후 주문이 종료됩니다.",
    "desc": "<strong>지속 시간:</strong> 1분<br>자신감으로 자신을 감쌉니다. 현재 {{condition:Frightened}} 수치를 <strong>1 감소</strong>시키고, 지속 시간 동안 {{condition:Frightened}} 상태가 될 때마다 그 수치를 <strong>1 감소</strong>시킵니다. {{condition:Frightened}} 효과에 대해 대실패를 하면, 자신감의 장막이 해당 효과의 {{condition:Frightened}} 수치를 줄인 후 주문이 종료됩니다."
  },
  {
    "id": "vibrant-thorns",
    "name_ko": "활기찬 가시",
    ...
    "duration": "1분",
    "summary": "몸에 가시가 자라납니다. 비무장 타격에 1d6 관통 피해 추가. 잡기를 시도하는 적에 가시 피해.",
    "desc": "<strong>지속 시간:</strong> 1분<br>몸에 가시가 자라납니다. 비무장 타격에 <strong>1d6 관통 피해 추가</strong>. 잡기를 시도하는 적에 가시 피해."
  },
  {
    "id": "waking-nightmare",
    "name_ko": "깨어난 악몽",
    ...
    "summary": "사거리: 30피트 | 대상: 생물 1 | 내성 굴림: 의지 | 지속 시간: 다양생물의 마음을 공포스러운 환영으로 가득 채웁니다. 대상은 의지 내성을 시도해야 합니다. 이 주문으로 공포 상태가 된 생물은 타격에 적중당할 때마다 추가로 1 정신 피해를 받습니다.대성공: 대상은 영향 없음.성공: 대상은 공포 1.실패: 대상은 공포 2. 잠든 ...",
    "desc": "<strong>사거리:</strong> 30피트 | <strong>대상:</strong> 생물 1 | <strong>내성 굴림:</strong> 의지 | <strong>지속 시간:</strong> 다양<br>생물의 마음을 공포스러운 환영으로 가득 채웁니다. 대상은 의지 내성을 시도해야 합니다. 이 주문으로 {{condition:Frightened}} 상태가 된 생물은 타격에 적중당할 때마다 추가로 <strong>1 정신 피해</strong>를 받습니다.<br><strong>대성공:</strong> 대상은 영향 없음.<br><strong>성공:</strong> 대상은 <strong>{{condition:Frightened}} 1</strong>.<br><strong>실패:</strong> 대상은 <strong>{{condition:Frightened}} 2</strong>. 잠든 상태였다면 깨어나며 <strong>1라운드 동안 {{condition:Paralyzed}}</strong>됩니다.<br><strong>대실패:</strong> 실패와 같지만 <strong>{{condition:Frightened}} 3</strong>.<br><strong>강화(+1):</strong> 타격 시 추가 정신 피해가 1 증가합니다."
  },
  {
    "id": "weapon-surge",
    "name_ko": "무기 강화",
  ...
  },
  {
    ...
    "desc": "<strong>지속 시간:</strong> 1라운드<br>당신이 진실이라고 믿는 진술을 말합니다. 진술은 말 비틀기, 생략 등을 통한 속임수 시도가 없어야 하며, <strong>25단어 이하</strong>여야 합니다. 신격의 상징이 머리 위에 빛나며 주문 지속 시간 동안 유지됩니다. 당신을 보고 듣는 모든 생물은 당신이 말하는 것을 진실로 믿는다는 것을 본능적으로 알게 됩니다. 이 정직함의 보증은 상징이 지속되는 동안 외교 판정에 <strong>+2 상태 보너스</strong>를 부여합니다. 주문을 해제할 수 있으며, 완전히 사실이라고 믿지 않는 것을 말하면 진술을 마치기 전에 주문이 종료됩니다."
  },
  {
  ...
  },
  {
    ...
    "defense": "의지",
    "duration": "1분",
    "summary": "매혹적 존재감. 영역에 들어온 적이 의지 실패 시 매혹. 매혹된 동안 당신에 대한 적대 행동에 DC 5 단순 판정.",
    "desc": "<strong>영역:</strong> 15피트 발산<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 1분<br>매혹적 존재감. 영역에 들어온 적이 의지 실패 시 <strong>{{condition:Charmed}}(fascinated)</strong>. 매혹된 동안 당신에 대한 적대 행동에 DC 5 단순 판정."
  },
  {
    "id": "commanding-lash",
    "name_ko": "명령의 채찍",
    ...
    "summary": "더 많은 고통을 가하겠다는 위협으로, 최근 해를 입힌 생물에게 명령을 내립니다. 명령 주문의 효과로 대상에게 명령을 합니다. 대상이 공포, 현기증, 또는 지속 피해를 받는 중이라면 내성에 -2 상황 페널티를 받습니다. 결과에 관계없이, 대상은 이후 1시간 동안 일시 면역이 됩니다.",
  ...
  },
  {
    ...
    "defense": "인내",
    "duration": "1분",
    "summary": "대상의 시야를 어둡게 합니다. 인내 실패 시 현혹됨. 대실패 시 실명(1라운드 후 현혹됨으로 전환).",
  ...
  },
  {
    ...
    "summary": "유발 피해를 받은 후 공기로 변합니다. 현재 턴이 끝날 때까지 공격이나 대상으로 삼을 수 없고, 공간을 차지하지 않으며, 행동할 수 없고, 가지고 있던 기운이나 발산이 억제됩니다. 턴이 끝나면 분산된 위치에서 15피트 이내의 점유 가능한 공간에 원래 형태로 돌아옵니다. 분산 중 지속 시간이 만료되지 않은 기운이나 발산은 복원됩니다.",
    "desc": "<strong>유발 조건:</strong> 적이나 위험에서 피해를 받음<br>유발 피해를 받은 후 공기로 변합니다. 현재 턴이 끝날 때까지 공격이나 대상으로 삼을 수 없고, 공간을 차지하지 않으며, 행동할 수 없고, 가지고 있던 기운이나 발산이 억제됩니다. 턴이 끝나면 분산된 위치에서 <strong>15피트 이내</strong>의 점유 가능한 공간에 원래 형태로 돌아옵니다. 분산 중 지속 시간이 만료되지 않은 기운이나 발산은 복원됩니다."
  },
  {
    "id": "downpour",
    "name_ko": "폭포",
    ...
    "desc": "<strong>영역:</strong> 30피트 폭발<br><strong>지속 시간:</strong> 1분<br>폭우를 내립니다. 영역이 <strong>{{condition:Concealed}}</strong>를 제공하고 비마법 화염을 끕니다. 영역 내 화염 주문의 피해가 절반."
  },
  {
    "id": "dreamers-call",
    "name_ko": "꿈꾸는 자의 부름",
    ...
    "defense": "의지",
    "duration": "대상의 다음 턴 끝까지",
    "summary": "대상의 꿈의 이미지에서 끌어낸 생생하고 환상적인 백일몽을 만들어냅니다. 백일몽은 사거리 내 비어있는 공간에 나타나며, 대상을 끌어당기려 합니다.대성공: 대상은 영향 없음.성공: 대상의 주의가 흔들립니다. 백일몽에 매혹됩니다.실패: 대상은 백일몽에 매혹되어, 첫 행동으로 다음 행동 과정 중 하나를 선택하여 추구합니다: 백일몽에 접근...",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 대상의 다음 턴 끝까지<br>대상의 꿈의 이미지에서 끌어낸 생생하고 환상적인 백일몽을 만들어냅니다. 백일몽은 사거리 내 비어있는 공간에 나타나며, 대상을 끌어당기려 합니다.<br><strong>대성공:</strong> 대상은 영향 없음.<br><strong>성공:</strong> 대상의 주의가 흔들립니다. 백일몽에 <strong>{{condition:Charmed}}(fascinated)</strong>됩니다.<br><strong>실패:</strong> 대상은 백일몽에 매혹되어, 첫 행동으로 다음 행동 과정 중 하나를 선택하여 추구합니다: 백일몽에 접근(도주 상태처럼), 들고 있는 것을 놓아주기(제물로), 또는 엎드려 절하기(넘어뜨려짐). 대상은 당신이 이 주문을 시전했음을 인지하지 못합니다.<br><strong>대실패:</strong> 성공과 같지만, 상태 페널티가 -4이며 자신의 야심을 추구하도록 격려받고 있어 자동으로 암시를 따릅니다."
  },
  {
    "id": "enduring-might",
    "name_ko": "지속하는 힘",
  ...
  },
  {
    ...
    "summary": "뮤즈: 마에스트로뮤즈에 호소하여 용기의 찬가, 집결의 찬가, 또는 힘의 노래 작곡의 혜택을 크게 증가시킵니다. 다음 행동이 이 작곡 중 하나를 시전하는 것이라면, 공연 판정을 시도합니다. DC는 보통 작곡 대상 중 가장 높은 의지 DC이지만, GM이 상황에 따라 다른 DC를 지정할 수 있습니다. 작곡의 효과는 판...",
    "desc": "<strong>뮤즈:</strong> 마에스트로<br>뮤즈에 호소하여 <em>용기의 찬가</em>, <em>집결의 찬가</em>, 또는 <em>힘의 노래</em> 작곡의 혜택을 크게 증가시킵니다. 다음 행동이 이 작곡 중 하나를 시전하는 것이라면, 공연 판정을 시도합니다. DC는 보통 작곡 대상 중 가장 높은 의지 DC이지만, GM이 상황에 따라 다른 DC를 지정할 수 있습니다. 작곡의 효과는 판정 결과에 따라 달라집니다.<br><strong>대성공:</strong> 작곡의 상태 보너스가 <strong>+3</strong>으로 증가합니다.<br><strong>성공:</strong> 작곡의 상태 보너스가 <strong>+2</strong>로 증가합니다.<br><strong>실패:</strong> 작곡은 정상적인 +1 보너스만 제공하지만, 이 주문에 집중점을 소비하지 않습니다."
  },
  {
  ...
  },
  {
    ...
    "target": "언데드 1",
    "duration": "1분",
    "summary": "언데드에 공허 에너지를 주입하여 강화합니다. 대상이 빠른 치유 5를 얻습니다.강화(+1): 빠른 치유 +2.",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 언데드 1<br><strong>지속 시간:</strong> 1분<br>언데드에 공허 에너지를 주입하여 강화합니다. 대상이 <strong>빠른 치유 5</strong>를 얻습니다.<br><strong>강화(+1):</strong> 빠른 치유 +2."
  },
  {
    "id": "mystic-beacon",
    "name_ko": "신비의 등대",
  ...
  },
  {
    ...
    "summary": "손바닥 크기의 날것 과일이나 채소가 당신의 빈 손에 나타납니다. 생물이 상호작용 행동으로 이 음식을 먹으면 3d10+12 HP를 회복하고 한 끼를 먹은 것처럼 영양이 보충됩니다. 먹지 않으면 1분 후 먼지로 부서집니다.강화(+1): 회복 HP가 6 증가합니다.",
    "desc": "<strong>요구사항:</strong> 빈 손이 있어야 합니다.<br>손바닥 크기의 날것 과일이나 채소가 당신의 빈 손에 나타납니다. 생물이 상호작용 행동으로 이 음식을 먹으면 <strong>3d10+12 HP</strong>를 회복하고 한 끼를 먹은 것처럼 영양이 보충됩니다. 먹지 않으면 1분 후 먼지로 부서집니다.<br><strong>강화(+1):</strong> 회복 HP가 6 증가합니다."
  },
  {
    "id": "perfected-body",
    "name_ko": "완벽한 몸",
    ...
    "desc": "<strong>유발 조건:</strong> 변형/독/변이 특성, {{condition:Clumsy}}/운명/{{condition:Enfeebled}}/{{condition:Petrified}}/메스꺼움을 부여하는 효과에 내성 실패/대실패<br>몸의 완벽함이 약간 더 건강하게 유지합니다. <strong>대실패를 실패로, 실패를 성공으로</strong> 변경합니다."
  },
  {
    "id": "precious-metals",
    "name_ko": "귀금속",
    ...
    "target": "금속 무기 1",
    "duration": "1분",
    "summary": "무기를 귀금속으로 일시 변환합니다. 냉철 또는 은으로 변환하여 해당 재료의 약점을 활용할 수 있습니다.",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 금속 무기 1<br><strong>지속 시간:</strong> 1분<br>무기를 귀금속으로 일시 변환합니다. 냉철 또는 은으로 변환하여 해당 재료의 약점을 활용할 수 있습니다."
  },
  {
    ...
    "duration": "유지",
    "summary": "사거리 내 정착지의 시대정신을 감지합니다. 정착지의 이름을 알게 됩니다. 해당 정착지에 대한 지식 회상이나 정보 수집의 모든 지식 판정에 +2 상태 보너스를 얻으며, 미숙련이더라도 레벨을 숙련도 보너스로 사용합니다. 주문 시전 시 지식 기술로 즉시 지식 회상을 할 수 있습니다. 이 주문을 다시 시전하면 이전 시전이 종료됩니다.강화(5랭크):...",
    "desc": "<strong>지속 시간:</strong> 유지<br>사거리 내 정착지의 시대정신을 감지합니다. 정착지의 이름을 알게 됩니다. 해당 정착지에 대한 지식 회상이나 정보 수집의 모든 지식 판정에 <strong>+2 상태 보너스</strong>를 얻으며, 미숙련이더라도 레벨을 숙련도 보너스로 사용합니다. 주문 시전 시 지식 기술로 즉시 지식 회상을 할 수 있습니다. 이 주문을 다시 시전하면 이전 시전이 종료됩니다.<br><strong>강화(5랭크):</strong> 사거리 100마일. <strong>강화(7랭크):</strong> 사거리 500마일, 보너스 +3."
  },
  {
    "id": "rebuke-death",
    "name_ko": "죽음의 거부",
  ...
  },
  {
    ...
    "target": "표면 1",
    "duration": "다음 일일 준비까지",
    "summary": "공중에 보이지 않는 눈 모양의 룬을 새겨, 투시와 같은 감지기를 만듭니다. 생성 시 이 눈은 당신의 시야 내에 있어야 합니다. 주문의 지속 시간이 끝날 때마다, 자유 행동으로 집중점 1점을 소비하여 지속 시간을 1시간 더 연장할 수 있습니다(다음 일일 준비 시 즉시 종료).",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 표면 1<br><strong>지속 시간:</strong> 다음 일일 준비까지<br>공중에 보이지 않는 눈 모양의 룬을 새겨, <em>투시</em>와 같은 감지기를 만듭니다. 생성 시 이 눈은 당신의 시야 내에 있어야 합니다. 주문의 지속 시간이 끝날 때마다, 자유 행동으로 집중점 1점을 소비하여 지속 시간을 1시간 더 연장할 수 있습니다(다음 일일 준비 시 즉시 종료)."
  },
  {
    "id": "safeguard-secret",
    "name_ko": "비밀 수호",
  ...
  },
  {
    ...
    "defense": "의지",
    "duration": "다양",
    "summary": "대상과 마음을 합쳐 괴로운 환영을 교환합니다. 의지 내성에 따라 둘 중 하나가 혼란 상태가 됩니다.대성공: 당신이 1라운드 동안 혼란.성공: 당신의 다음 턴 시작 시, 혼란 상태로 첫 행동을 수행하고 이후 정상 행동.실패: 대상은 매 턴 시작 시 혼란 상태로 첫 행동을 수행합니다. 지속 시간 1분.대실패: 대상은 혼란. 지속 시간 1분.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 다양<br>대상과 마음을 합쳐 괴로운 환영을 교환합니다. 의지 내성에 따라 둘 중 하나가 <strong>{{condition:Confused}}</strong> 상태가 됩니다.<br><strong>대성공:</strong> 당신이 <strong>1라운드</strong> 동안 {{condition:Confused}}.<br><strong>성공:</strong> 당신의 다음 턴 시작 시, {{condition:Confused}} 상태로 첫 행동을 수행하고 이후 정상 행동.<br><strong>실패:</strong> 대상은 매 턴 시작 시 {{condition:Confused}} 상태로 첫 행동을 수행합니다. 지속 시간 1분.<br><strong>대실패:</strong> 대상은 {{condition:Confused}}. 지속 시간 1분."
  },
  {
    "id": "shifting-form",
    "name_ko": "변형",
  ...
  },
  {
    ...
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 유지(최대 1분)<br>끔찍한 환영의 소용돌이. 의지 실패 시 <strong>{{condition:Frightened}} 2+4d6 정신 피해</strong>. 유지 시 재피해(2d6 정신, 의지 절반)."
  },
  {
    "id": "take-its-course",
    "name_ko": "경과 관찰",
  ...
  },
  {
    ...
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br>생물을 해방하는 자유의 말을 내뱉습니다. 다음 상태 중 하나를 선택하여 억제합니다: {{condition:Confused}}, {{condition:Frightened}}, 잡힘, {{condition:Paralyzed}}, {{condition:Restrained}}. 대상은 선택한 상태의 영향을 받지 않으며, 잡힘이나 구속을 억제하면 주문 시전 시 자동으로 해방됩니다.<br>상태를 제공한 효과 자체를 제거하지 않으면, 주문이 끝난 후 상태가 돌아옵니다. 예를 들어, 혼란을 1분간 주는 주문이 있다면, 자유의 말씀은 1라운드 동안 대상이 정상적으로 행동하게 하지만, {{condition:Confused}} 상태는 이후에 돌아옵니다."
  },
  {
    "id": "zeal-for-battle",
    "name_ko": "전투 열정",
    ...
    "area": "10피트 발산",
    "trigger": "우선권 굴림 시작",
    "summary": "전투 열정이 불타오릅니다. 영역 내 아군이 우선권 굴림에 +2 상태 보너스. 가장 높은 우선권을 가진 아군 1명은 1라운드간 가속(보폭/타격에만 사용 가능).",
  ...
  },
  {
    ...
    "summary": "당신의 송가가 죽음을 막습니다. 대상의 빈사 수치가 사망 수치보다 1 낮게 유지됩니다. 분해나 죽음 효과처럼 빈사 수치를 올리지 않고 죽이는 효과에는 도움이 되지 않습니다.",
    "desc": "<strong>사거리:</strong> 60피트<br><strong>대상:</strong> 유발 생물<br><strong>유발 조건:</strong> 생물의 {{condition:Dying}} 수치가 사망 수치에 도달할 때<br>당신의 송가가 죽음을 막습니다. 대상의 {{condition:Dying}} 수치가 사망 수치보다 <strong>1 낮게</strong> 유지됩니다. {{spell:Disintegrate}}나 죽음 효과처럼 {{condition:Dying}} 수치를 올리지 않고 죽이는 효과에는 도움이 되지 않습니다."
  },
  {
    ...
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 당신 또는 아군 1<br>공연 판정으로 잡힘, 속박, {{condition:Paralyzed}}, {{condition:Restrained}}, {{condition:Slowed}}, {{condition:Stunned}} 중 하나를 상쇄합니다. 상태의 원천에 따라 상쇄 DC 결정.<br><strong>강화(9랭크):</strong> 최대 4 대상."
  },
  {
    "id": "soothing-ballad",
    "name_ko": "위로의 발라드",
    ...
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 당신+최대 9 아군<br>뮤즈에 의지하여 아군을 치유합니다. 세 가지 효과 중 선택: {{condition:Frightened}} 상쇄 시도, {{condition:Paralyzed}} 상쇄 시도, 또는 <strong>7d8 HP 회복</strong>.<br><strong>강화(+1):</strong> 치유 시 +1d8."
  },
  {
    "id": "impaling-briars",
    "name_ko": "가시 꿰뚫기",
  ...
  },
  {
    ...
    "desc": "<strong>영역:</strong> 5피트 발산<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 1분<br>청취자를 황홀하게 하여 따라오도록 합니다. 유지 시 반경 +5피트. 실패 시 {{condition:Charmed}}+모든 행동으로 당신을 향해 이동+칭찬. 대실패 시 하수인 특성+지배당함."
  },
  {
    "id": "air-bubble",
    "name_ko": "공기 방울",
  ...
  },
  {
    ...
    "target": "생물 1",
    "duration": "8시간",
    "summary": "대상의 근골격계를 강화하여 더 많은 무게를 견딜 수 있게 합니다. 대상은 과적 상태가 되기 전에 3 부피를 추가로 운반할 수 있으며, 최대 6 부피까지 추가로 운반할 수 있습니다.",
  ...
  },
  {
    ...
    "defense": "의지",
    "duration": "1분",
    "summary": "적의 마음을 의심으로 채웁니다. 영역 내 적은 의지 내성에 성공하거나 영역에 있는 한 명중 굴림에 -1 상태 페널티를 받아야 합니다. 이후 매 턴 한 번 주문을 유지하여 발산 반경을 10피트씩 증가시키고, 아직 영향받지 않은 영역 내 적에게 새로운 내성을 강요할 수 있습니다. 재앙은 축복을 상쇄할 수 있습니다.",
  ...
  },
  {
    ...
    "area": "15피트 발산",
    "duration": "1분",
    "summary": "아군의 공격을 영역 내에서 강화합니다. 영역 내의 당신을 포함한 아군은 영역에 있는 한 명중 굴림에 +1 상태 보너스를 얻습니다. 이후 매 턴 한 번 주문을 유지하여 발산 반경을 10피트씩 증가시킬 수 있습니다. 축복은 재앙을 상쇄할 수 있습니다.",
  ...
  },
  {
    ...
    "defense": "의지",
    "duration": "대상의 다음 턴 끝까지",
    "summary": "대상에게 한 마디 명령을 내립니다. 다음 중 하나를 선택합니다:다가오기: 대상은 자신의 다음 턴에 당신을 향해 이동합니다.도망치기: 대상은 자신의 다음 턴에 가능한 한 빨리 당신에게서 멀어집니다.놓기: 대상은 들고 있는 모든 것을 떨어뜨립니다.엎드리기: 대상은 엎드려집니다.일어서기(Stand...",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 대상의 다음 턴 끝까지<br>대상에게 한 마디 명령을 내립니다. 다음 중 하나를 선택합니다:<br><strong>다가오기:</strong> 대상은 자신의 다음 턴에 당신을 향해 이동합니다.<br><strong>도망치기:</strong> 대상은 자신의 다음 턴에 가능한 한 빨리 당신에게서 멀어집니다.<br><strong>놓기:</strong> 대상은 들고 있는 모든 것을 떨어뜨립니다.<br><strong>엎드리기:</strong> 대상은 엎드려집니다.<br><strong>일어서기:</strong> 대상은 아무것도 하지 않습니다.<br>대상은 의지 내성을 시도합니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> 영향 없음.<br><strong>실패:</strong> 자신의 다음 턴 <strong>첫 번째 행동</strong>으로 명령한 행동을 수행해야 합니다.<br><strong>대실패:</strong> 대상은 다음 턴의 <strong>모든 행동</strong>을 명령을 수행하는 데 사용해야 합니다.<br><strong>강화(5랭크):</strong> 최대 <strong>10</strong> 생물을 대상으로 삼을 수 있습니다."
  },
  {
    "id": "create-water",
    "name_ko": "물 생성",
  ...
  },
  {
    ...
    "area": "15피트 원뿔",
    "defense": "의지",
    "summary": "현란하게 소용돌이치는 색채의 폭발이 영역 내 생물의 시야를 어지럽힙니다. 영역 내 각 생물은 의지 내성을 시도합니다.대성공: 영향 없음.성공: 1라운드 동안 현혹됨.실패: 기절 1, 1라운드 동안 실명, 1분 동안 현혹됨.대실패: 1라운드 동안 기절, 1분 동안 실명(bl...",
  ...
  },
  {
    ...
    "defense": "인내",
    "duration": "1분",
    "summary": "대상의 근육과 힘줄을 약화시키는 에너지를 보냅니다. 대상은 인내 내성을 시도합니다.대성공: 영향 없음.성공: 주문의 지속 시간 동안 약화 1 상태가 됩니다.실패: 주문의 지속 시간 동안 약화 2 상태가 됩니다.대실패: 주문의 지속 시간 동안 약화 3 상태가 됩니다.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 인내<br><strong>지속 시간:</strong> 1분<br>대상의 근육과 힘줄을 약화시키는 에너지를 보냅니다. 대상은 인내 내성을 시도합니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> 주문의 지속 시간 동안 <strong>{{condition:Enfeebled}} 1</strong> 상태가 됩니다.<br><strong>실패:</strong> 주문의 지속 시간 동안 <strong>{{condition:Enfeebled}} 2</strong> 상태가 됩니다.<br><strong>대실패:</strong> 주문의 지속 시간 동안 <strong>{{condition:Enfeebled}} 3</strong> 상태가 됩니다."
  },
  {
    "id": "fear",
    "name_ko": "공포",
    ...
    "target": "생물 1",
    "defense": "의지",
    "summary": "대상에게 불안과 공포의 파동을 보내 겁먹게 합니다. 대상은 의지 내성을 시도합니다.대성공: 영향 없음.성공: 공포 1 상태가 됩니다.실패: 공포 2 상태가 됩니다.대실패: 공포 3 상태가 되고, 1라운드 동안 도주 상태가 됩니다.강화(3랭크): 최대 5명의 생물을 대상으로 삼을 수 있습니다.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br>대상에게 불안과 공포의 파동을 보내 겁먹게 합니다. 대상은 의지 내성을 시도합니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> <strong>{{condition:Frightened}} 1</strong> 상태가 됩니다.<br><strong>실패:</strong> <strong>{{condition:Frightened}} 2</strong> 상태가 됩니다.<br><strong>대실패:</strong> <strong>{{condition:Frightened}} 3</strong> 상태가 되고, <strong>1라운드</strong> 동안 <strong>{{condition:Fleeing}}</strong> 상태가 됩니다.<br><strong>강화(3랭크):</strong> 최대 <strong>5</strong>명의 생물을 대상으로 삼을 수 있습니다."
  },
  {
    "id": "fleet-step",
    "name_ko": "순발력",
  ...
  },
  {
    ...
    "target": "생물 1",
    "defense": "인내",
    "summary": "대성공: 영향 없음.성공: 메스꺼움 1.실패: 고블린 천연두 1단계에 감염됩니다.대실패: 고블린 천연두 2단계에 감염됩니다.고블린 천연두(질병, 레벨 1): 1단계: 메스꺼움 1 (1라운드); 2단계: 메스꺼움 1과 둔화 1 (1라운드); 3단계: 메스꺼움 1이며 1 미만으로 줄일 수 없음 (1일).",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 인내<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> <strong>{{condition:Sickened}} 1</strong>.<br><strong>실패:</strong> 고블린 천연두 1단계에 감염됩니다.<br><strong>대실패:</strong> 고블린 천연두 2단계에 감염됩니다.<br><strong>고블린 천연두(질병, 레벨 1):</strong> 1단계: {{condition:Sickened}} 1 (1라운드); 2단계: {{condition:Sickened}} 1과 {{condition:Slowed}} 1 (1라운드); 3단계: {{condition:Sickened}} 1이며 1 미만으로 줄일 수 없음 (1일)."
  },
  {
    "id": "grease",
    "name_ko": "기름칠",
  ...
  },
  {
    ...
    "target": "아이템 1개",
    "duration": "1시간",
    "summary": "대상 아이템을 다른 아이템처럼 보이게 만듭니다. 아이템은 같은 부피를 가진 비마법 아이템의 외형을 취할 수 있지만, 실제보다 품질이 낮거나 더 낡은 것처럼 보입니다(또는 원한다면 부서지지 않을 것처럼 보이게 할 수도 있습니다). 아이템과 상호작용하는 성공적인 조작 행동 또는 탐색 행동은 환영을 불신하기 위한 의지...",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 아이템 1개<br><strong>지속 시간:</strong> 1시간<br>대상 아이템을 다른 아이템처럼 보이게 만듭니다. 아이템은 같은 부피를 가진 비마법 아이템의 외형을 취할 수 있지만, 실제보다 품질이 낮거나 더 낡은 것처럼 보입니다(또는 원한다면 부서지지 않을 것처럼 보이게 할 수도 있습니다). 아이템과 상호작용하는 성공적인 조작 행동 또는 탐색 행동은 환영을 불신하기 위한 의지 내성 굴림을 허용합니다.<br><strong>강화(3랭크):</strong> 아이템은 같은 유형의 다른 아이템처럼 보일 수 있습니다(예: 다른 종류의 음식, 또는 다른 종류의 목재). 또한 최대 1 부피만큼 더 무겁거나 가벼운 비마법 아이템처럼 보일 수도 있습니다."
  },
  {
    "id": "jump",
    "name_ko": "도약",
  ...
  },
  {
    ...
    "target": "잠긴 문, 용기 등 1",
    "duration": "다음 일일 준비까지",
    "summary": "자물쇠를 훨씬 열기 어렵게 만듭니다. 도둑질 DC에 +4 상태 보너스를 추가합니다. 열쇠 주문은 잠금의 랭크에 따라 상쇄를 시도합니다.",
  ...
  },
  {
    ...
    "castTime": "10분",
    "summary": "대상 아이템을 수리합니다. 주문 랭크당 5 HP를 회복시키며, 파손 한계치를 넘으면 파손 상태가 해제됩니다. 잃어버린 부품을 교체하거나 완전히 파괴된 물체를 수리할 수는 없습니다.강화(2랭크): 1 부피 이하의 비마법 물체.강화(3랭크): 2 부피 이하의 비마법 물체, 또는 1 부피 이하의 마법 물체.",
  ...
  },
  {
    ...
    "duration": "10분",
    "summary": "위협적이지 않은 작은 동물로 변신합니다. 고양이, 곤충, 도마뱀, 쥐 중 하나. 작은 크기. AC = 15 + 레벨. 속도 20피트. 물리 약점 5. 미광 시각, 부정확 후각 30피트. 곡예 및 은신 +10(자신의 수정치가 더 높으면 그것을 사용). 운동 -4.강화(4랭크): 날 수 있는 생물도 선택 가능, 비행 속도 20피트.",
    "desc": "<strong>지속 시간:</strong> 10분<br>위협적이지 않은 작은 동물로 변신합니다. 고양이, 곤충, 도마뱀, 쥐 중 하나. 작은 크기. AC = 15 + 레벨. 속도 20피트. 물리 약점 5. 미광 시각, 부정확 후각 30피트. 곡예 및 은신 +10(자신의 수정치가 더 높으면 그것을 사용). 운동 -4.<br><strong>강화(4랭크):</strong> 날 수 있는 생물도 선택 가능, 비행 속도 20피트."
  },
  {
    "id": "pet-cache",
    "name_ko": "반려 은닉",
  ...
  },
  {
    ...
    "defense": "의지",
    "duration": "1분",
    "summary": "환영의 고통이 대상을 괴롭힙니다. 2d4 정신 피해와 1d4 지속 정신 피해, 의지 내성.대성공: 영향 없음.성공: 전체 초기 피해, 지속 피해 없음, 주문 즉시 종료.실패: 전체 초기 및 지속 피해, 메스꺼움 1. 메스꺼움에서 회복하면 지속 피해와 주문이 종료됩니다.대실패: 실패와 같지만, 메스꺼움 2.강화(+1): 초기 피해 +2...",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 1분<br>환영의 고통이 대상을 괴롭힙니다. <strong>2d4 정신 피해</strong>와 <strong>1d4 지속 정신 피해</strong>, 의지 내성.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> 전체 초기 피해, 지속 피해 없음, 주문 즉시 종료.<br><strong>실패:</strong> 전체 초기 및 지속 피해, <strong>{{condition:Sickened}} 1</strong>. 메스꺼움에서 회복하면 지속 피해와 주문이 종료됩니다.<br><strong>대실패:</strong> 실패와 같지만, <strong>{{condition:Sickened}} 2</strong>.<br><strong>강화(+1):</strong> 초기 피해 +2d4, 지속 피해 +1d4."
  },
  {
    "id": "protection",
    "name_ko": "보호",
  ...
  },
  {
    ...
    "target": "동의하는 생물 1",
    "duration": "1분",
    "summary": "생물의 비무장 공격에 일시적으로 마법 룬을 적용합니다. 비무장 공격이 +1 타격 무기가 된 것처럼 명중 굴림에 +1 아이템 보너스를 얻고 피해 주사위가 2개가 됩니다.강화(6랭크): +2 상위 타격. 강화(9랭크): +3 최상위 타격.",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 동의하는 생물 1<br><strong>지속 시간:</strong> 1분<br>생물의 비무장 공격에 일시적으로 마법 룬을 적용합니다. 비무장 공격이 +1 타격 무기가 된 것처럼 명중 굴림에 <strong>+1 아이템 보너스</strong>를 얻고 피해 주사위가 2개가 됩니다.<br><strong>강화(6랭크):</strong> +2 상위 타격. <strong>강화(9랭크):</strong> +3 최상위 타격."
  },
  {
    "id": "runic-weapon",
    "name_ko": "문자 무기",
    ...
    "duration": "1분",
    "summary": "무기에 일시적으로 마법 룬을 적용합니다. 무기가 +1 타격 무기가 됩니다.강화(6랭크): +2 상위 타격. 강화(9랭크): +3 최상위 타격.",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 무기 1(무주인 또는 동의하는 생물이 든)<br><strong>지속 시간:</strong> 1분<br>무기에 일시적으로 마법 룬을 적용합니다. 무기가 +1 타격 무기가 됩니다.<br><strong>강화(6랭크):</strong> +2 상위 타격. <strong>강화(9랭크):</strong> +3 최상위 타격."
  },
  {
    "id": "sanctuary",
    "name_ko": "성소",
  ...
  },
  {
    ...
    "area": "5피트 폭발",
    "defense": "의지",
    "summary": "영역 내 각 생물이 졸음에 빠집니다. 잠든 생물은 엎드리거나 들고 있는 물건을 떨어뜨리지 않습니다. 지각 판정 성공으로 깨어나는 것을 막지 않으므로, 전투 유용성이 제한됩니다.대성공: 영향 없음.성공: 1라운드 동안 지각 판정에 -1 상태 페널티.실패: 무의식. 1분 후에도 무의식이면 자동으로 깨어남.대실패: 무의식. 1시간 후...",
  ...
  },
  {
    ...
    "target": "생물 1",
    "defense": "인내",
    "summary": "1d4 관통 피해 + 거미 독. 대성공: 영향 없음. 성공: 1d4 독 피해. 실패: 거미 독 1단계. 대실패: 거미 독 2단계.거미 독(독): 레벨 1; 최대 지속 4라운드; 1단계: 1d4 독 피해 + 약화 1 (1라운드); 2단계: 1d4 독 피해 + 약화 2 (1라운드).",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 인내<br><strong>1d4 관통 피해</strong> + 거미 독. <strong>대성공:</strong> 영향 없음. <strong>성공:</strong> 1d4 독 피해. <strong>실패:</strong> 거미 독 1단계. <strong>대실패:</strong> 거미 독 2단계.<br>거미 독(독): 레벨 1; 최대 지속 4라운드; 1단계: 1d4 독 피해 + {{condition:Enfeebled}} 1 (1라운드); 2단계: 1d4 독 피해 + {{condition:Enfeebled}} 2 (1라운드)."
  },
  {
    "id": "spirit-link",
    "name_ko": "영혼 연결",
  ...
  },
  {
    ...
    "traits": [],
    "duration": "턴 종료까지",
    "summary": "다음 명중 굴림에서 d20을 두 번 굴려 높은 것을 사용합니다. 명중 굴림에 대한 상황 페널티와 은폐 또는 숨겨짐으로 인한 일반 판정을 무시합니다.",
    "desc": "<strong>지속 시간:</strong> 턴 종료까지<br>다음 명중 굴림에서 <strong>d20을 두 번 굴려 높은 것을 사용</strong>합니다. 명중 굴림에 대한 상황 페널티와 {{condition:Concealed}} 또는 {{condition:Hidden}}으로 인한 일반 판정을 무시합니다."
  },
  {
    "id": "tailwind",
    "name_ko": "순풍",
  ...
  },
  {
    ...
    "target": "생물 1",
    "defense": "기본 반사",
    "summary": "천둥과 함께 번개 덩굴이 내려쳐 1d12 전기 피해와 1d4 음파 피해를 줍니다(기본 반사 내성). 금속 갑옷이나 금속으로 이루어진 대상은 내성에 -1 상황 페널티를 받으며, 피해를 받으면 1라운드 동안 서투름 1이 됩니다.강화(+1): 전기 피해 +1d12, 음파 피해 +1d4.",
  ...
  },
  {
    ...
    "desc": "<strong>사거리:</strong> 120피트<br><strong>대상:</strong> 작은 동물 1<br><strong>지속 시간:</strong> 다음 일일 준비까지<br>작은 동물에게 메시지를 맡겨 지정 위치의 지정 대상에게 전달하게 합니다. 동물이 일반 속도로 이동하여 대상에게 도달하면 메시지를 전달합니다."
  },
  {
    "id": "blazing-bolt",
    "name_ko": "타오르는 화살",
  ...
  },
  {
    ...
    "target": "생물 1",
    "duration": "1분",
    "summary": "대상의 형체가 흐릿하게 나타납니다. 대상은 은폐 상태가 됩니다. 이 효과의 특성상 대상의 위치는 여전히 명확하므로, 대상은 이 은폐를 이용하여 숨기나 은밀 이동을 할 수 없습니다.",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 생물 1<br><strong>지속 시간:</strong> 1분<br>대상의 형체가 흐릿하게 나타납니다. 대상은 <strong>{{condition:Concealed}}</strong> 상태가 됩니다. 이 효과의 특성상 대상의 위치는 여전히 명확하므로, 대상은 이 은폐를 이용하여 숨기나 은밀 이동을 할 수 없습니다."
  },
  {
    "id": "calm",
    "name_ko": "진정",
  ...
  },
  {
    ...
    "range": "접촉",
    "target": "동의 생물 1",
    "summary": "정신 오염을 몰아냅니다. 도주, 공포, 현기증 중 하나를 부여하는 효과에 상쇄를 시도합니다. 상쇄 실패해도 랭크가 2 낮았으면 성공했을 경우, 다음 턴 시작까지 효과를 억압합니다.강화(4랭크): 혼란, 지배 추가. 강화(6랭크): 운명 추가....",
  ...
  },
  {
    ...
    "duration": "1시간",
    "summary": "어둠 속에서도 볼 수 있는 초자연적 시각을 부여합니다. 주문의 지속 시간 동안 암시야를 얻어, 어둠 속에서도 흑백으로 볼 수 있습니다. 이것은 마법적 어둠에는 효과가 없습니다.강화(3랭크): 사거리가 접촉이 되고 동의하는 생물 1명을 대상으로 삼을 수 있습니다.강화(5랭크): 사거리 접촉, 동의하는 생물 1명, 지속 시간이 다음 ...",
    "desc": "<strong>지속 시간:</strong> 1시간<br>어둠 속에서도 볼 수 있는 초자연적 시각을 부여합니다. 주문의 지속 시간 동안 <strong>암시야</strong>를 얻어, 어둠 속에서도 흑백으로 볼 수 있습니다. 이것은 마법적 어둠에는 효과가 없습니다.<br><strong>강화(3랭크):</strong> 사거리가 접촉이 되고 동의하는 생물 1명을 대상으로 삼을 수 있습니다.<br><strong>강화(5랭크):</strong> 사거리 접촉, 동의하는 생물 1명, 지속 시간이 다음 일일 준비까지로 증가합니다."
  },
  {
    "id": "deafness",
    "name_ko": "귀머거리",
    ...
    "target": "생물 1",
    "defense": "인내",
    "summary": "대상의 청각을 빼앗아 귀머거리로 만듭니다. 대상은 인내 내성을 시도합니다.대성공: 영향 없음.성공: 대상의 다음 턴 끝까지 귀머거리 상태가 됩니다.실패: 10분 동안 귀머거리 상태가 됩니다.대실패: 영구적으로 귀머거리 상태가 됩니다.주문의 효과가 끝난 후 대상은 이 주문에 대해 1분간 면역이 됩니다.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 인내<br>대상의 청각을 빼앗아 귀머거리로 만듭니다. 대상은 인내 내성을 시도합니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> 대상의 다음 턴 끝까지 <strong>{{condition:Deafened}}</strong> 상태가 됩니다.<br><strong>실패:</strong> <strong>10분</strong> 동안 {{condition:Deafened}} 상태가 됩니다.<br><strong>대실패:</strong> <strong>영구적으로</strong> {{condition:Deafened}} 상태가 됩니다.<br>주문의 효과가 끝난 후 대상은 이 주문에 대해 <strong>1분간 면역</strong>이 됩니다."
  },
  {
    "id": "dispel-magic",
    "name_ko": "마법 해제",
  ...
  },
  {
    ...
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 물체 1(영역에 {{condition:Immobilized}})<br><strong>지속 시간:</strong> 다음 일일 준비까지<br>물체에 환영 메시지를 남겨 나중에 발동되게 합니다. 시전 시 메시지(최대 25단어)와 발동 조건을 설정합니다. 조건이 충족되면 당신의 환영 이미지가 나타나 메시지를 전합니다.<br><strong>강화(+2):</strong> 메시지를 25단어 더 추가 가능."
  },
  {
    "id": "enlarge",
    "name_ko": "확대",
    ...
    "target": "동의하는 생물 1",
    "duration": "5분",
    "summary": "마법적 힘으로 대상이 대형 크기로 성장합니다. 장비도 함께 커지지만 제거하면 원래 크기로 돌아옵니다. 대상은 서투름 1이 됩니다. 도달이 5피트 증가하며(초소형에서 시작했다면 10피트), 근접 피해에 +2 상태 보너스를 얻습니다. 이 주문은 대형 이상 생물에게 효과가 없습니다.강화(4랭크): 대상이 거대 크기로 성장합니다. 근접 피해 상...",
  ...
  },
  {
    ...
    "area": "영역 내 모든 5피트 칸",
    "duration": "1분",
    "summary": "식물을 자라게 하여 영역 내 이동을 방해합니다. 영역은 험지가 됩니다. 영역 내에서 턴을 시작하는 각 생물은 반사 내성 시도. 실패 시 이동 불가(탈출 DC = 주문 DC). 대실패 시 넘어뜨려짐+이동 불가.",
  ...
  },
  {
    ...
    "target": "생물 1",
    "duration": "다음 일일 준비까지",
    "summary": "극심한 추위나 더위로부터 생물을 보호합니다. 대상은 심한 이하의 환경 온도 효과를 무시합니다.강화(3랭크): 극심한 온도까지 보호. 강화(5랭크): 극한 온도까지 보호.",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 생물 1<br><strong>지속 시간:</strong> 다음 일일 준비까지<br>극심한 추위나 더위로부터 생물을 보호합니다. 대상은 <strong>심한</strong> 이하의 환경 온도 효과를 무시합니다.<br><strong>강화(3랭크):</strong> <strong>극심한</strong> 온도까지 보호. <strong>강화(5랭크):</strong> <strong>극한</strong> 온도까지 보호."
  },
  {
    "id": "everlight",
    "name_ko": "영원한 빛",
  ...
  },
  {
    ...
    "defense": "의지",
    "duration": "유지(최대 1분)",
    "summary": "웃음이 생물의 행동을 방해합니다. 의지 실패 시 서투름 2+집중 주문에 DC 5 단순 판정 필요. 대실패 시 추가로 엎드려짐.",
  ...
  },
  {
    ...
    "area": "20피트 폭발",
    "duration": "1분",
    "summary": "짙은 안개 구름이 영역을 뒤덮습니다. 영역 내의 모든 생물과 물체는 은폐 상태가 됩니다. 은폐된 대상을 공격하려면 DC 5 단순 판정에 성공해야 하며, 실패하면 공격이 빗나갑니다. 강한 바람은 안개를 날려 보낼 수 있습니다.",
  ...
  },
  {
    ...
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 1분<br><strong>성공:</strong> 모든 사람이 잠재적 위협이라고 믿으며 모두에게 {{condition:Unfriendly}}. 효과는 1라운드 동안 지속.<br><strong>대실패:</strong> 모든 사람이 치명적 적이라고 믿으며, 모든 대상에 대해 반응과 자유 행동을 사용합니다.<br><strong>강화(6랭크):</strong> 최대 5명 대상."
  },
  {
    "id": "peaceful-rest",
    "name_ko": "평화로운 안식",
  ...
  },
  {
    ...
    "defense": "반사",
    "duration": "다양",
    "summary": "마법의 빛이 영역을 휩쓸어 숨겨진 것을 드러냅니다. 빛의 외양(다채로운 불꽃, 반짝이는 빛 등)을 선택할 수 있습니다. 영향받는 생물은 현혹 상태가 됩니다. 투명한 생물이었다면 은폐 상태로 변합니다. 다른 이유로 이미 은폐된 생물은 은폐 상태가 해제됩니다.대성공: 영향 없음. 성공: 2라운드. 실패: 1분. 대실패:...",
    "desc": "<strong>사거리:</strong> 120피트<br><strong>영역:</strong> 10피트 폭발<br><strong>방어:</strong> 반사<br><strong>지속 시간:</strong> 다양<br>마법의 빛이 영역을 휩쓸어 숨겨진 것을 드러냅니다. 빛의 외양(다채로운 불꽃, 반짝이는 빛 등)을 선택할 수 있습니다. 영향받는 생물은 <strong>{{condition:Dazzled}}</strong> 상태가 됩니다. 투명한 생물이었다면 <strong>{{condition:Concealed}}</strong> 상태로 변합니다. 다른 이유로 이미 은폐된 생물은 {{condition:Concealed}} 상태가 해제됩니다.<br><strong>대성공:</strong> 영향 없음. <strong>성공:</strong> 2라운드. <strong>실패:</strong> 1분. <strong>대실패:</strong> 10분."
  },
  {
    "id": "see-the-unseen",
    "name_ko": "보이지 않는 것 보기",
    ...
    "duration": "10분",
    "summary": "투명한 생물을 흐릿하게 볼 수 있어 은폐 상태로 취급되며 식별이 어렵습니다. 무형체 생물도 10피트 이내에서 물체를 통해 흐릿한 형태로 보입니다. 환영을 불신하는 판정에 +2 상태 보너스를 얻습니다.강화(5랭크): 지속 시간 8시간.",
    "desc": "<strong>지속 시간:</strong> 10분<br>투명한 생물을 흐릿하게 볼 수 있어 <strong>{{condition:Concealed}}</strong> 상태로 취급되며 식별이 어렵습니다. 무형체 생물도 10피트 이내에서 물체를 통해 흐릿한 형태로 보입니다. 환영을 불신하는 판정에 <strong>+2 상태 보너스</strong>를 얻습니다.<br><strong>강화(5랭크):</strong> 지속 시간 8시간."
  },
  {
    "id": "shape-wood",
    "name_ko": "나무 형성",
  ...
  },
  {
    ...
    "target": "동의 생물 1",
    "duration": "5분",
    "summary": "동의하는 생물을 작은 크기로 줄입니다. 범위가 0이 됩니다.강화(6랭크): 최대 10명.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 동의 생물 1<br><strong>지속 시간:</strong> 5분<br>동의하는 생물을 작은 크기로 줄입니다. 범위가 0이 됩니다.<br><strong>강화(6랭크):</strong> 최대 10명."
  },
  {
    "id": "silence",
    "name_ko": "침묵",
    ...
    "target": "동의 생물 1",
    "duration": "1분",
    "summary": "동의하는 생물에서 나오는 모든 소리를 마법적으로 음소거합니다. 대상은 어떤 소리도 내지 않으며, 음파 공격이나 청각 행동을 사용할 수 없습니다. 예외: 은밀 특성을 가진 주문은 시전 가능합니다.강화(4랭크): 대상 대신 10피트 발산 영역으로 변경됩니다. 영역 내 모든 소리가 차단되며, 영역 내 생물도 같은 효과를 받습니다.",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 동의 생물 1<br><strong>지속 시간:</strong> 1분<br>동의하는 생물에서 나오는 모든 소리를 마법적으로 음소거합니다. 대상은 어떤 소리도 내지 않으며, 음파 공격이나 청각 행동을 사용할 수 없습니다. 예외: 은밀 특성을 가진 주문은 시전 가능합니다.<br><strong>강화(4랭크):</strong> 대상 대신 <strong>10피트 발산</strong> 영역으로 변경됩니다. 영역 내 모든 소리가 차단되며, 영역 내 생물도 같은 효과를 받습니다."
  },
  {
    "id": "sound-body",
    "name_ko": "건전한 몸",
    ...
    "range": "접촉",
    "target": "동의하는 생물 1",
    "summary": "물리적 상태를 상쇄합니다. 실명, 현혹, 귀머거리, 약화, 메스꺼움 중 하나를 상쇄 시도합니다. 상쇄 랭크가 2 이상 낮으면 다음 턴 시작까지 억제만 합니다. 저주, 질병, 정상 상태는 상쇄/억제 불가.강화(4랭크): 소진, 기...",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 동의하는 생물 1<br>물리적 상태를 상쇄합니다. {{condition:Blinded}}, {{condition:Dazzled}}, {{condition:Deafened}}, {{condition:Enfeebled}}, {{condition:Sickened}} 중 하나를 상쇄 시도합니다. 상쇄 랭크가 2 이상 낮으면 다음 턴 시작까지 억제만 합니다. 저주, 질병, 정상 상태는 상쇄/억제 불가.<br><strong>강화(4랭크):</strong> {{condition:Drained}}, {{condition:Stunned}} 추가. <strong>강화(8랭크):</strong> 소진, {{condition:Stunned}} 및 전체 목록 추가."
  },
  {
  ...
  },
  {
    ...
    "target": "동의하는 살아있는 생물 1",
    "duration": "다음 일일 준비까지",
    "summary": "같은 차원에 있고 둘 다 살아있으면 대상의 거리, 방향, 현재 상태를 알 수 있습니다.강화(4랭크): 사거리 30피트, 최대 10명.",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 동의하는 살아있는 생물 1<br><strong>지속 시간:</strong> 다음 일일 준비까지<br>같은 차원에 있고 둘 다 살아있으면 대상의 거리, 방향, 현재 상태를 알 수 있습니다.<br><strong>강화(4랭크):</strong> 사거리 30피트, 최대 10명."
  },
  {
    "id": "stupefy",
    "name_ko": "멍청하게",
    ...
    "defense": "의지",
    "duration": "다양",
    "summary": "대상의 정신을 둔하게 하여 주문시전을 불안정하게 만듭니다.대성공: 영향 없음. 성공: 다음 턴 시작까지 현기증 1. 실패: 1분 동안 현기증 2. 대실패: 1분 동안 현기증 3.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 다양<br>대상의 정신을 둔하게 하여 주문시전을 불안정하게 만듭니다.<br><strong>대성공:</strong> 영향 없음. <strong>성공:</strong> 다음 턴 시작까지 {{condition:Stupefied}} 1. <strong>실패:</strong> 1분 동안 {{condition:Stupefied}} 2. <strong>대실패:</strong> 1분 동안 {{condition:Stupefied}} 3."
  },
  {
    "id": "summon-elemental",
    "name_ko": "정령 소환",
  ...
  },
  {
    ...
    "range": "60피트",
    "target": "생물 1",
    "summary": "생물을 염동력으로 무장 해제, 밀기, 넘어뜨리기합니다. 운동 판정 대신 주문 명중 굴림을 사용합니다.",
    "desc": "<strong>사거리:</strong> 60피트<br><strong>대상:</strong> 생물 1<br>생물을 염동력으로 무장 해제, 밀기, 넘어뜨리기합니다. 운동 판정 대신 주문 명중 굴림을 사용합니다."
  },
  {
    "id": "translate",
    "name_ko": "번역",
  ...
  },
  {
    ...
    "duration": "1일",
    "summary": "힘의 말로 무심한 언데드를 제어합니다. 대상은 하수인 특성을 얻고 당신의 명령에 복종합니다. 당신은 각 턴에 행동 1개를 소비하여 대상에게 명령을 내릴 수 있습니다. 대상이 하수인 특성을 가지는 동안, 명령 없이는 자발적으로 행동하지 않습니다. 당신이나 아군이 대상에게 적대 행동을 하면 주문이 즉시 종료됩니다. 주문이 끝나면 대상이 갑자...",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 주문 랭크 이하 레벨의 무심한 언데드 1<br><strong>지속 시간:</strong> 1일<br>힘의 말로 무심한 언데드를 제어합니다. 대상은 <strong>하수인</strong> 특성을 얻고 당신의 명령에 복종합니다. 당신은 각 턴에 행동 1개를 소비하여 대상에게 명령을 내릴 수 있습니다. 대상이 하수인 특성을 가지는 동안, 명령 없이는 자발적으로 행동하지 않습니다. 당신이나 아군이 대상에게 적대 행동을 하면 주문이 즉시 종료됩니다. 주문이 끝나면 대상이 갑자기 해방되며 적대적이 될 수 있습니다."
  },
  {
    "id": "blindness",
    "name_ko": "실명",
    ...
    "target": "생물 1",
    "defense": "인내",
    "summary": "대상의 눈에서 빛을 빼앗아 눈멀게 하려 시도합니다. 대상은 인내 내성을 시도합니다.대성공: 영향 없음.성공: 대상의 다음 턴 끝까지 실명 상태가 됩니다.실패: 1분 동안 실명 상태가 됩니다.대실패: 영구적으로 실명 상태가 됩니다.주문의 효과가 끝난 후 대상은 이 주문에 대해 1분간 면역이 됩니다.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 인내<br>대상의 눈에서 빛을 빼앗아 눈멀게 하려 시도합니다. 대상은 인내 내성을 시도합니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> 대상의 다음 턴 끝까지 <strong>{{condition:Blinded}}</strong> 상태가 됩니다.<br><strong>실패:</strong> <strong>1분</strong> 동안 {{condition:Blinded}} 상태가 됩니다.<br><strong>대실패:</strong> <strong>영구적으로</strong> {{condition:Blinded}} 상태가 됩니다.<br>주문의 효과가 끝난 후 대상은 이 주문에 대해 <strong>1분간 면역</strong>이 됩니다."
  },
  {
  ...
  },
  {
    ...
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br>대상의 신앙을 공격하여 의심과 정신적 혼란을 일으킵니다. <strong>6d6 정신 피해</strong>(신성 주문시전자에게는 6d8).<br><strong>대성공:</strong> 영향 없음. <strong>성공:</strong> 절반 피해. <strong>실패:</strong> 전체 피해; 신성 시전자면 {{condition:Stupefied}} 1(1라운드). <strong>대실패:</strong> 2배 피해, {{condition:Stupefied}} 1(1라운드), 신성 주문 시전 불가(1라운드).<br>자신의 신격 추종자에게 중대한 이유 없이 시전하면 대부분의 신에게 금기.<br><strong>강화(+1):</strong> 피해 +2d6(또는 신성 시전자에게 +2d8)."
  },
  {
    "id": "dream-message",
    "name_ko": "꿈의 전언",
  ...
  },
  {
    ...
    "defense": "의지",
    "duration": "유지(최대 10분)",
    "summary": "당신의 말과 몸짓이 주변 생물을 사로잡습니다. 대상은 의지 내성을 시도합니다.대성공: 영향 없음. 이 시전에 대해 면역이 됩니다.성공: 영향 없음.실패: 대상이 매혹 상태가 되어, 당신의 연설에 집중해야 합니다. 매혹된 동안 다른 행동에 -2 상태 페널티를 받습니다. 대상에게 적대 행동을 하면 매혹이 즉시 종료됩니다. 주문을 유지...",
    "desc": "<strong>사거리:</strong> 120피트<br><strong>대상:</strong> 당신의 말을 들을 수 있는 모든 생물<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 유지(최대 10분)<br>당신의 말과 몸짓이 주변 생물을 사로잡습니다. 대상은 의지 내성을 시도합니다.<br><strong>대성공:</strong> 영향 없음. 이 시전에 대해 면역이 됩니다.<br><strong>성공:</strong> 영향 없음.<br><strong>실패:</strong> 대상이 <strong>{{condition:Charmed}}(fascinated)</strong> 상태가 되어, 당신의 연설에 집중해야 합니다. 매혹된 동안 다른 행동에 -2 상태 페널티를 받습니다. 대상에게 적대 행동을 하면 매혹이 즉시 종료됩니다. 주문을 유지하면 {{condition:Charmed}} 상태가 지속됩니다.<br><strong>대실패:</strong> 실패와 같지만, 대상은 자신이 매혹당했음을 인지하지 못합니다."
  },
  {
  ...
  },
  {
    ...
    "duration": "5분",
    "summary": "무기가 반투명하고 유령 같은 모습이 되어 물질적 존재와 무형 존재 모두에 영향을 줍니다. 유령 접촉 속성 룬의 효과를 얻습니다. 마법 무기가 아니었다면 마법 무기가 됩니다.",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 주인 없거나 당신 또는 아군이 들고 있는 무기 1<br><strong>지속 시간:</strong> 5분<br>무기가 반투명하고 유령 같은 모습이 되어 물질적 존재와 무형 존재 모두에 영향을 줍니다. 유령 접촉 속성 룬의 효과를 얻습니다. 마법 무기가 아니었다면 마법 무기가 됩니다."
  },
  {
    "id": "haste",
    "name_ko": "가속",
    ...
    "target": "생물 1",
    "duration": "1분",
    "summary": "생물의 속도를 높여 더 자주 공격하거나 이동할 수 있게 합니다. 대상이 가속 상태가 되어 매 턴 추가 행동 1개를 얻으며, 이 행동은 보폭 또는 타격에만 사용 가능.강화(7랭크): 최대 6 생물 대상.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>지속 시간:</strong> 1분<br>생물의 속도를 높여 더 자주 공격하거나 이동할 수 있게 합니다. 대상이 <strong>{{condition:Quickened}}</strong> 상태가 되어 매 턴 <strong>추가 행동 1개</strong>를 얻으며, 이 행동은 <strong>보폭 또는 타격</strong>에만 사용 가능.<br><strong>강화(7랭크):</strong> 최대 6 생물 대상."
  },
  {
    "id": "heroism",
    "name_ko": "영웅심",
  ...
  },
  {
    ...
    "actions": "1행동",
    "traits": [],
    "summary": "방대한 양의 정보를 순간적으로 회상합니다. 즉시 6회의 지식 회상 판정을 할 수 있으며(각각 다른 주제), 다중 공격 페널티 등은 적용되지 않습니다.",
    "desc": "방대한 양의 정보를 순간적으로 회상합니다. 즉시 <strong>6회의 지식 회상 판정</strong>을 할 수 있으며(각각 다른 주제), 다중 공격 페널티 등은 적용되지 않습니다."
  },
  {
    "id": "hypnotize",
    "name_ko": "최면",
    ...
    "defense": "의지",
    "duration": "유지(최대 1라운드)",
    "summary": "빠르게 변화하는 색채와 무늬의 폭발이 영역 내 생물의 시선을 사로잡습니다. 각 생물은 의지 내성을 시도합니다.대성공: 영향 없음.성공: 현혹됨 1라운드.실패: 매혹 상태가 됩니다. 유지하면 매혹이 지속됩니다. 적대 행동을 받으면 매혹 종료.대실패: 매혹 상태 + 기절 2.",
    "desc": "<strong>영역:</strong> 30피트 발산<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 유지(최대 1라운드)<br>빠르게 변화하는 색채와 무늬의 폭발이 영역 내 생물의 시선을 사로잡습니다. 각 생물은 의지 내성을 시도합니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> <strong>{{condition:Dazzled}}</strong> 1라운드.<br><strong>실패:</strong> <strong>{{condition:Charmed}}(fascinated)</strong> 상태가 됩니다. 유지하면 매혹이 지속됩니다. 적대 행동을 받으면 {{condition:Charmed}} 종료.<br><strong>대실패:</strong> <strong>{{condition:Charmed}}</strong> 상태 + <strong>{{condition:Stunned}} 2</strong>."
  },
  {
    "id": "insect-form",
    "name_ko": "곤충 형태",
  ...
  },
  {
    ...
    "defense": "반사",
    "duration": "유지(최대 1분)",
    "summary": "대상 주위에 작은 눈보라가 소용돌이칩니다. 1d6 냉기 피해(반사)+대상이 은폐(다른 이에 대해). 유지 시 재피해.강화(+1): 피해 +1d6.",
  ...
  },
  {
    ...
    "target": "최대 10 동의 생물",
    "duration": "10분",
    "summary": "불굴의 확신과 열정을 동의하는 생물에 불어넣습니다. 대상이 10 임시 HP를 얻고, 공포 및 도주에 대한 내성에 +2 상태 보너스.강화(+1): 임시 HP +3.",
  ...
  },
  {
    ...
    "defense": "의지",
    "duration": "1분",
    "summary": "대상의 정신을 뒤흔들어 혼란에 빠뜨립니다. 대상은 의지 내성을 시도합니다. 혼란 상태에서 생물은 자신의 턴마다 DC 11 단순 판정을 합니다. 실패하면 인접한 무작위 생물(아군 포함)을 타격합니다. 단순 판정에 성공하면 해당 턴에는 정상적으로 행동합니다. 각 턴 종료 시 추가 의지 내성을 시도하여 성공하면 주문이 종료됩니다.대성공: 영향...",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 1분<br>대상의 정신을 뒤흔들어 혼란에 빠뜨립니다. 대상은 의지 내성을 시도합니다. {{condition:Confused}} 상태에서 생물은 자신의 턴마다 DC 11 단순 판정을 합니다. 실패하면 인접한 무작위 생물(아군 포함)을 타격합니다. 단순 판정에 성공하면 해당 턴에는 정상적으로 행동합니다. 각 턴 종료 시 추가 의지 내성을 시도하여 성공하면 주문이 종료됩니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> <strong>1라운드</strong> 동안 {{condition:Confused}} 상태가 됩니다.<br><strong>실패:</strong> <strong>1분</strong> 동안 {{condition:Confused}} 상태가 됩니다.<br><strong>대실패:</strong> <strong>1분</strong> 동안 {{condition:Confused}} 상태가 되며, 턴 종료 시 내성으로 벗어날 수 없습니다.<br><strong>강화(8랭크):</strong> 30피트 폭발 영역 내 모든 생물을 대상으로 삼을 수 있습니다."
  },
  {
    "id": "creation",
    "name_ko": "창조",
  ...
  },
  {
    ...
    "area": "20피트 폭발",
    "defense": "인내",
    "summary": "신성의 분노를 적들에게 쏟아붓습니다. 영역 내 적들에게 인내 내성에 따라 4d10 영혼 피해를 줍니다.대성공: 대상에게 영향 없음.성공: 대상이 절반 피해를 받습니다.실패: 대상이 전체 피해를 받고 메스꺼움 1 상태가 됩니다.대실패: 대상이 전체 피해를 받고 메스꺼움 2 상태가 됩니다. 메스꺼움 상태인 동안 둔화(s...",
    "desc": "<strong>사거리:</strong> 120피트<br><strong>영역:</strong> 20피트 폭발<br><strong>방어:</strong> 인내<br>신성의 분노를 적들에게 쏟아붓습니다. 영역 내 적들에게 인내 내성에 따라 <strong>4d10 영혼 피해</strong>를 줍니다.<br><strong>대성공:</strong> 대상에게 영향 없음.<br><strong>성공:</strong> 대상이 절반 피해를 받습니다.<br><strong>실패:</strong> 대상이 전체 피해를 받고 <strong>{{condition:Sickened}} 1</strong> 상태가 됩니다.<br><strong>대실패:</strong> 대상이 전체 피해를 받고 <strong>{{condition:Sickened}} 2</strong> 상태가 됩니다. {{condition:Sickened}} 상태인 동안 <strong>{{condition:Slowed}} 1</strong> 상태이기도 합니다.<br><strong>강화(+1):</strong> 피해가 1d10 증가합니다."
  },
  {
    "id": "fire-shield",
    "name_ko": "화염 방패",
    ...
    "duration": "1분",
    "summary": "떠다니는 화염 방패가 당신 곁을 따릅니다. 냉기 저항 5를 얻고, 온화하고 심각한 환경 냉기에 면역이 됩니다. 방패 올리기: AC에 +1 상황 보너스. 방패 막기: 경도 10, 화염 면역, 40 HP(파손 한계치 없음), 물 효과는 경도를 절반으로 줄입니다. 근접 비무장 또는 인접 생물의 공격을 방...",
    "desc": "<strong>지속 시간:</strong> 1분<br>떠다니는 화염 방패가 당신 곁을 따릅니다. <strong>냉기 저항 5</strong>를 얻고, 온화하고 심각한 환경 냉기에 면역이 됩니다. 방패 올리기: AC에 <strong>+1 상황 보너스</strong>. {{feat:Shield Block}}: 경도 10, 화염 면역, <strong>40 HP</strong>(파손 한계치 없음), 물 효과는 경도를 절반으로 줄입니다. 근접 비무장 또는 인접 생물의 공격을 방패 막기로 막으면, 공격자가 <strong>2d6 화염 피해</strong>를 받습니다.<br><strong>강화(+2):</strong> 냉기 저항 +5, HP +10, 화염 피해 +1d6."
  },
  {
    "id": "flicker",
    "name_ko": "깜빡임",
  ...
  },
  {
    ...
    "duration": "10분",
    "summary": "가장 터무니없는 거짓말도 더 믿을 만하게 만듭니다. 기만 판정에 +4 상태 보너스를 얻습니다.",
    "desc": "<strong>지속 시간:</strong> 10분<br>가장 터무니없는 거짓말도 더 믿을 만하게 만듭니다. 기만 판정에 <strong>+4 상태 보너스</strong>를 얻습니다."
  },
  {
    "id": "liminal-doorway",
    "name_ko": "경계의 문",
    ...
    "range": "60피트",
    "duration": "1시간",
    "summary": "두 장소를 연결하는 그림자 문을 만들어냅니다. 이 주문을 시전할 때 사거리 내의 목표 칸을 선택하여 먼 쪽 위치로 지정하고, 당신에게 인접한 출발 칸을 가까운 쪽 위치로 지정합니다. 당신과 동의하는 다른 생물들은 문을 통과할 수 있으며, 이는 단 하나의 행동만 필요하고 걷기로 계산됩니다. 가까운 쪽으로 들어가면 먼 쪽으로 나오며, 먼 쪽으로...",
    "desc": "<strong>사거리:</strong> 60피트<br><strong>지속 시간:</strong> 1시간<br>두 장소를 연결하는 그림자 문을 만들어냅니다. 이 주문을 시전할 때 사거리 내의 목표 칸을 선택하여 먼 쪽 위치로 지정하고, 당신에게 인접한 출발 칸을 가까운 쪽 위치로 지정합니다. 당신과 동의하는 다른 생물들은 문을 통과할 수 있으며, 이는 단 하나의 행동만 필요하고 걷기로 계산됩니다. 가까운 쪽으로 들어가면 먼 쪽으로 나오며, 먼 쪽으로 들어가면 가까운 쪽으로 나옵니다.<br><strong>강화(2랭크):</strong> 지속 시간이 무제한이 되지만, 주문을 유지하기 위해 하루에 한 번 주문에 집중해야 합니다."
  },
  {
  ...
  },
  {
    ...
    "duration": "1일",
    "castTime": "10분",
    "summary": "대상에게 끔찍한 악몽을 보냅니다. 다음에 대상이 잠들면 의지 내성을 시도합니다. 이름으로만 알고 만난 적이 없다면 의지 내성에 +4 상황 보너스를 받습니다.대성공: 영향 없음, 1주일 동안 일시적 면역.성공: 악몽을 꾸지만 불쾌한 기억 외에 부정적 효과 없음.실패: 악몽을 꾸고 피로 상태로 깨어남.대실패: 악몽을 꾸고 피로 상태로 깨...",
    "desc": "<strong>사거리:</strong> 행성 전체<br><strong>대상:</strong> 이름을 아는 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 1일<br><strong>시전:</strong> 10분<br>대상에게 끔찍한 악몽을 보냅니다. 다음에 대상이 잠들면 의지 내성을 시도합니다. 이름으로만 알고 만난 적이 없다면 의지 내성에 <strong>+4 상황 보너스</strong>를 받습니다.<br><strong>대성공:</strong> 영향 없음, 1주일 동안 일시적 면역.<br><strong>성공:</strong> 악몽을 꾸지만 불쾌한 기억 외에 부정적 효과 없음.<br><strong>실패:</strong> 악몽을 꾸고 <strong>{{condition:Fatigued}}</strong> 상태로 깨어남.<br><strong>대실패:</strong> 악몽을 꾸고 {{condition:Fatigued}} 상태로 깨어나며, 더 이상 피로하지 않을 때까지 <strong>{{condition:Drained}} 2</strong>."
  },
  {
    "id": "outcasts-curse",
    "name_ko": "추방자의 저주",
  ...
  },
  {
    ...
    "summary": "돌을 대략적 형태로 재형성합니다. 생물이 돌 위에 있을 경우: 성공 시 영향 없음, 실패 시 엎드러짐, 대실패 시 돌에서 떨어져 엎드러짐.",
  ...
  },
  {
    ...
    "duration": "10분",
    "summary": "30피트 이내의 생물과 텔레파시로 소통할 수 있습니다. 연결이 설정되면 양방향 소통이 가능합니다. 같은 언어를 공유하는 생물과만 소통할 수 있습니다.강화(6랭크): 공유 정신 이미지를 사용하여 언어를 공유하지 않아도 소통 가능. 텔레파시가 언어 특성을 잃습니다.",
    "desc": "<strong>지속 시간:</strong> 10분<br>30피트 이내의 생물과 텔레파시로 소통할 수 있습니다. 연결이 설정되면 양방향 소통이 가능합니다. 같은 언어를 공유하는 생물과만 소통할 수 있습니다.<br><strong>강화(6랭크):</strong> 공유 정신 이미지를 사용하여 언어를 공유하지 않아도 소통 가능. 텔레파시가 언어 특성을 잃습니다."
  },
  {
    "id": "translocate",
    "name_ko": "순간이동",
  ...
  },
  {
    ...
    "target": "접촉한 생물 1",
    "duration": "10분",
    "summary": "방해를 물리칩니다. 주문 효과 동안 대상은 이동 속도에 상황 페널티를 주는 효과를 무시합니다. 이동 불가, 잡힘, 구속에서 탈출할 때, 마법적이고 더 높은 랭크의 효과라면 자동 성공합니다.",
  ...
  },
  {
    ...
    "target": "동의하는 생물 1",
    "duration": "5분",
    "summary": "비정형. 아이템 보너스 AC 및 기타 아이템 효과/보너스 상실. 비무장 방어 숙련 수정치 사용. 물리 피해에 저항 8. 정밀 피해 면역. 주문시전, 아이템 활성화, 공격/조작 특성 행동 불가. 비행 속도 10피트. 작은 틈 통과 가능. 해제 가능.",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 동의하는 생물 1<br><strong>지속 시간:</strong> 5분<br>비정형. 아이템 보너스 AC 및 기타 아이템 효과/보너스 상실. 비무장 방어 숙련 수정치 사용. 물리 피해에 저항 8. 정밀 피해 면역. 주문시전, 아이템 활성화, 공격/조작 특성 행동 불가. 비행 속도 10피트. 작은 틈 통과 가능. 해제 가능."
  },
  {
    "id": "vital-beacon",
    "name_ko": "활력 등대",
    ...
    "duration": "다음 일일 준비까지",
    "castTime": "1분",
    "summary": "활력을 발산합니다. 라운드당 1회, 생물이 상호작용하여 간청하면 치유됩니다. 등대는 약해집니다: 첫 번째 4d10, 두 번째 4d8, 세 번째 4d6, 네 번째 4d4, 이후 주문 종료. 한 번에 하나의 활력 등대만 활성 가능.강화(+1): 치유 시마다 해당 단계의 주사위 크기로 추가 1개 주사위.",
    "desc": "<strong>지속 시간:</strong> 다음 일일 준비까지<br><strong>시전:</strong> 1분<br>활력을 발산합니다. 라운드당 1회, 생물이 상호작용하여 간청하면 치유됩니다. 등대는 약해집니다: 첫 번째 4d10, 두 번째 4d8, 세 번째 4d6, 네 번째 4d4, 이후 주문 종료. 한 번에 하나의 활력 등대만 활성 가능.<br><strong>강화(+1):</strong> 치유 시마다 해당 단계의 주사위 크기로 추가 1개 주사위."
  },
  {
    "id": "wall-of-fire",
    "name_ko": "화염 벽",
    ...
    "range": "120피트",
    "duration": "1분",
    "summary": "5피트 두께의 화염 벽. 최대 60피트 직선과 10피트 높이, 또는 5피트 두께 10피트 반경 고리. 양쪽에서 반대편이 은폐. 벽을 통과하거나 턴 시작 시 벽 공간에 있는 생물은 4d6 화염 피해.강화(+1): 피해 +1d6.",
  ...
  },
  {
    ...
    "summary": "당신의 축복이 죽음의 순간에 생물을 되살립니다. 대상의 사망을 방지하고 5d8 HP를 회복시킵니다. 유발 효과가 죽음 효과이거나 분해처럼 잔해를 남기지 않는 효과인 경우에는 생명의 숨결을 사용할 수 없습니다.강화(+2): 회복 HP +1d8.",
  ...
  },
  {
    ...
    "area": "50피트×50피트",
    "defense": "인내(아래 참조)",
    "summary": "물의 수위를 10피트 올리거나 내립니다. 영역 내 물 특성 생물은 인내 내성으로 느리게 주문의 효과를 받습니다.",
  ...
  },
  {
    ...
    "target": "동의+잠자는 생물 1",
    "duration": "8시간",
    "summary": "대상이 꿈에서 재훈련합니다. 8시간 수면 후 대상은 1회 재훈련을 완료합니다(보통 1주가 걸리는 것을 하룻밤에).",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 동의+잠자는 생물 1<br><strong>지속 시간:</strong> 8시간<br>대상이 꿈에서 재훈련합니다. 8시간 수면 후 대상은 1회 재훈련을 완료합니다(보통 1주가 걸리는 것을 하룻밤에)."
  },
  {
    "id": "elemental-form",
    "name_ko": "정령 형태",
  ...
  },
  {
    ...
    "target": "생물 1",
    "defense": "반사",
    "summary": "냉철 말뚝으로 생물을 꿰뚫습니다. 8d6 관통 피해(반사). 실패 시 이동 불가(말뚝에 꿰뚫림). 탈출 DC = 주문 DC.강화(+1): 피해 +2d6.",
  ...
  },
  {
    ...
    "target": "생물 1",
    "defense": "의지",
    "summary": "거친 바다의 저주를 생물에게 감염시킵니다. 의지 실패 시 대상이 물 위에 있을 때 항상 메스꺼움 1(물 위를 벗어나도 남음). 대실패 시 메스꺼움 2. 저주는 해제되거나 상쇄될 때까지 지속.",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br>거친 바다의 저주를 생물에게 감염시킵니다. 의지 실패 시 대상이 물 위에 있을 때 항상 <strong>{{condition:Sickened}} 1</strong>(물 위를 벗어나도 남음). 대실패 시 {{condition:Sickened}} 2. 저주는 해제되거나 상쇄될 때까지 지속."
  },
  {
    "id": "sending",
    "name_ko": "전송",
  ...
  },
  {
    ...
    "defense": "반사",
    "duration": "1분",
    "summary": "그림자 뱀이 영역에 나타납니다. 3d6 관통 피해 + 1d6 지속 독 피해. 반사 내성에 따라 잡힘 또는 구속. 영역 안에서 턴을 끝내는 생물도 내성 시도. 뱀의 탈출 DC = 주문 DC. 뱀의 AC = 주문 DC. 12 이상 피해로 뱀 파괴(새 뱀 재성장).성공: 영향 없음. 실패: 전체 피해, 뱀에 잡힘. 대실...",
    "desc": "<strong>사거리:</strong> 120피트<br><strong>영역:</strong> 20피트 폭발<br><strong>방어:</strong> 반사<br><strong>지속 시간:</strong> 1분<br>그림자 뱀이 영역에 나타납니다. <strong>3d6 관통 피해 + 1d6 지속 독 피해</strong>. 반사 내성에 따라 {{condition:Grabbed}} 또는 {{condition:Restrained}}. 영역 안에서 턴을 끝내는 생물도 내성 시도. 뱀의 탈출 DC = 주문 DC. 뱀의 AC = 주문 DC. 12 이상 피해로 뱀 파괴(새 뱀 재성장).<br><strong>성공:</strong> 영향 없음. <strong>실패:</strong> 전체 피해, 뱀에 잡힘. <strong>대실패:</strong> 2배 피해, {{condition:Restrained}}.<br><strong>강화(+2):</strong> 지속 독 피해 +1d6, 뱀 HP +6."
  },
  {
  ...
  },
  {
    ...
    "range": "30피트",
    "duration": "유지(최대 1분)",
    "summary": "천상체 특성을 가진 5레벨 이하 생물을 소환합니다. 신성화 특성을 가집니다. GM이 특정 유형을 결정합니다.강화(6랭크 이후): 더 강한 천상 소환.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>지속 시간:</strong> 유지(최대 1분)<br>천상체 특성을 가진 5레벨 이하 생물을 소환합니다. 신성화 특성을 가집니다. GM이 특정 유형을 결정합니다.<br><strong>강화(6랭크 이후):</strong> 더 강한 천상 소환."
  },
  {
    "id": "summon-dragon",
    "name_ko": "용 소환",
  ...
  },
  {
    ...
    "range": "30피트",
    "duration": "유지(최대 1분)",
    "summary": "기형체를 소환합니다. 주문 랭크 -1 이하 레벨.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>지속 시간:</strong> 유지(최대 1분)<br>기형체를 소환합니다. 주문 랭크 -1 이하 레벨."
  },
  {
    "id": "summon-fiend",
    "name_ko": "악마 소환",
    ...
    "range": "30피트",
    "duration": "유지(최대 1분)",
    "summary": "악마 특성을 가진 5레벨 이하 생물을 소환합니다. 부정화 특성을 가집니다. 신앙에 따라 특정 유형이 제한됩니다.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>지속 시간:</strong> 유지(최대 1분)<br>악마 특성을 가진 5레벨 이하 생물을 소환합니다. 부정화 특성을 가집니다. 신앙에 따라 특정 유형이 제한됩니다."
  },
  {
    "id": "summon-monitor",
    "name_ko": "주시자 소환",
    ...
    "range": "30피트",
    "duration": "유지(최대 1분)",
    "summary": "주시자 특성을 가진 5레벨 이하 생물을 소환합니다. 신앙에 따라 유형이 제한됩니다.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>지속 시간:</strong> 유지(최대 1분)<br>주시자 특성을 가진 5레벨 이하 생물을 소환합니다. 신앙에 따라 유형이 제한됩니다."
  },
  {
    "id": "synaptic-pulse",
    "name_ko": "시냅스 파동",
    ...
    "defense": "의지",
    "duration": "1라운드",
    "summary": "영역 내 모든 적에게 정신 폭발을 가합니다.대성공: 영향 없음. 성공: 기절 1. 실패: 기절 2. 대실패: 기절 1라운드.",
    "desc": "<strong>영역:</strong> 30피트 발산<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 1라운드<br>영역 내 모든 적에게 정신 폭발을 가합니다.<br><strong>대성공:</strong> 영향 없음. <strong>성공:</strong> {{condition:Stunned}} 1. <strong>실패:</strong> {{condition:Stunned}} 2. <strong>대실패:</strong> {{condition:Stunned}} 1라운드."
  },
  {
    "id": "telekinetic-haul",
    "name_ko": "염동 운반",
  ...
  },
  {
    ...
    "duration": "8시간",
    "castTime": "1분",
    "summary": "암흑계를 통해 여행합니다. 1시간 = 보통 3일 이동 거리. 목적지는 모호하고 상징적입니다. 해제하거나 지속 시간 종료 시 의도한 목적지에서 1마일 이내에 도착.",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 자신+접촉한 최대 10 동의 생물<br><strong>지속 시간:</strong> 8시간<br><strong>시전:</strong> 1분<br>암흑계를 통해 여행합니다. 1시간 = 보통 3일 이동 거리. 목적지는 모호하고 상징적입니다. 해제하거나 지속 시간 종료 시 의도한 목적지에서 1마일 이내에 도착."
  },
  {
    "id": "wall-of-ice",
    "name_ko": "얼음 벽",
  ...
  },
  {
    ...
    "desc": "<strong>영역:</strong> 30피트 원뿔<br><strong>방어:</strong> 의지<br>영역 내 생물을 절망에 빠뜨립니다. 의지 실패 시 <strong>{{condition:Frightened}} 2+{{condition:Slowed}} 1</strong>(1라운드). 대실패 시 {{condition:Frightened}} 3+{{condition:Slowed}} 1(1분).<br><strong>강화(+1):</strong> 원뿔 크기 +5피트."
  },
  {
    "id": "blessed-boundary",
    "name_ko": "축복받은 경계",
  ...
  },
  {
    ...
    "desc": "<strong>지속 시간:</strong> 유지(최대 1분)<br>당신이 투명해지면서, 동시에 당신처럼 보이고 행동하는 환영 복제본을 만듭니다. 복제본은 당신의 마지막 위치에 나타나며, 주문을 유지하면서 턴마다 복제본을 이동시키고 간단한 행동(걷기, 말하기 등)을 하게 할 수 있습니다. 복제본은 피해를 줄 수 없으며, 물리적 상호작용을 하면 환영이 불신됩니다. 당신이 적대 행동을 하면 {{condition:Invisible}} 상태가 1라운드 동안 해제되지만, 복제본은 유지됩니다."
  },
  {
    "id": "never-mind",
    "name_ko": "망각",
    ...
    "target": "생물 1",
    "defense": "의지",
    "summary": "생물을 영구적으로 멍청하게 만듭니다. 의지 실패 시 현기증 4(영구). 대실패 시 현기증 4+혼란 1라운드. 이 효과는 저주이며 상쇄로만 제거 가능.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br>생물을 영구적으로 멍청하게 만듭니다. 의지 실패 시 <strong>{{condition:Stupefied}} 4</strong>(영구). 대실패 시 {{condition:Stupefied}} 4+<strong>{{condition:Confused}} 1라운드</strong>. 이 효과는 저주이며 상쇄로만 제거 가능."
  },
  {
    "id": "petrify",
    "name_ko": "석화",
    ...
    "defense": "인내",
    "duration": "다양",
    "summary": "대상의 몸이 천천히 돌로 변해갑니다. 대상은 인내 내성을 시도합니다.대성공: 영향 없음.성공: 1라운드 동안 둔화 1.실패: 둔화 1, 매 턴 끝에 인내 내성을 시도합니다(이 반복 내성은 무력화 특성을 가짐). 실패 시 둔화 수치가 1 증가(대실패 시 2 증가). 성공 시 둔화 수치가 1 감소합니다. 둔화로 인해 완전히 행동할 수 없게 ...",
    "desc": "<strong>사거리:</strong> 120피트<br><strong>대상:</strong> 유기물로 이루어진 생물 1<br><strong>방어:</strong> 인내<br><strong>지속 시간:</strong> 다양<br>대상의 몸이 천천히 돌로 변해갑니다. 대상은 인내 내성을 시도합니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> <strong>1라운드</strong> 동안 <strong>{{condition:Slowed}} 1</strong>.<br><strong>실패:</strong> <strong>{{condition:Slowed}} 1</strong>, 매 턴 끝에 인내 내성을 시도합니다(이 반복 내성은 무력화 특성을 가짐). 실패 시 {{condition:Slowed}} 수치가 1 증가(대실패 시 2 증가). 성공 시 {{condition:Slowed}} 수치가 1 감소합니다. 둔화로 인해 완전히 행동할 수 없게 되면, 영구적으로 석화됩니다. 둔화가 제거되면 주문도 종료됩니다.<br><strong>대실패:</strong> 실패와 같지만, 초기 둔화가 <strong>2</strong>입니다."
  },
  {
    ...
    "area": "30피트 폭발",
    "defense": "의지",
    "summary": "묵시록적 파멸의 환시가 영역 내 각 생물의 정신을 채웁니다. 11d6 정신 피해(기본 의지). 대실패 시 반사 내성이나 비슷한 판정에도 성공해야 하며, 실패하면(갈라진 틈에 빠지거나, 바다에 표류하는 등) 1분 동안 기절. 매 턴 끝에 새로운 의지 내성을 시도하여, 성공 시 환상을 불신하고 기절에서 회복합니다.강화(+1): 피해 +2d6.",
  ...
  },
  {
    ...
    "target": "생물 1",
    "defense": "기본 인내",
    "summary": "생물의 영적 본질에 피해를 줍니다. 16d6 영혼 피해(기본 인내).강화(+1): 피해 +2d6.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 기본 인내<br>생물의 영적 본질에 피해를 줍니다. <strong>16d6 영혼 피해</strong>(기본 인내).<br><strong>강화(+1):</strong> 피해 +2d6."
  },
  {
  ...
  },
  {
    ...
    "defense": "의지",
    "duration": "유지(최대 1분)",
    "summary": "맥동하는 빛. 영역 내 생물은 현혹. 시전 시, 진입 시, 턴 종료 시, 영역 내에서 탐색/상호작용 시 의지 내성. 이미 실명한 생물은 새 내성 불필요.성공: 영향 없음. 실패: 실명. 무늬에서 벗어나면 매 턴 종료 시 새 내성으로 회복 가능(최대 1분). 대실패: 실명 1분.",
    "desc": "<strong>사거리:</strong> 120피트<br><strong>영역:</strong> 10피트 폭발<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 유지(최대 1분)<br>맥동하는 빛. 영역 내 생물은 {{condition:Dazzled}}. 시전 시, 진입 시, 턴 종료 시, 영역 내에서 탐색/상호작용 시 의지 내성. 이미 실명한 생물은 새 내성 불필요.<br><strong>성공:</strong> 영향 없음. <strong>실패:</strong> {{condition:Blinded}}. 무늬에서 벗어나면 매 턴 종료 시 새 내성으로 회복 가능(최대 1분). <strong>대실패:</strong> {{condition:Blinded}} 1분."
  },
  {
    "id": "wall-of-force",
    "name_ko": "힘의 벽",
    ...
    "range": "30피트",
    "duration": "1분",
    "summary": "보이지 않는 순수 마법 힘의 벽을 형성합니다. 최대 50피트 길이, 20피트 높이. 끊어지지 않은 열린 공간에 만들어야 합니다. AC 10, 경도 30, HP 60. 치명타와 정밀 피해에 면역. 물리적 효과를 차단하며, 힘으로 되어 있으므로 무형체 생물과 에테르적 생물도 차단합니다. 순간이동 효과는 통과 가능(벽이 보이지 않으므로 시각 효...",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>지속 시간:</strong> 1분<br>보이지 않는 순수 마법 힘의 벽을 형성합니다. 최대 50피트 길이, 20피트 높이. 끊어지지 않은 열린 공간에 만들어야 합니다. AC 10, 경도 30, HP 60. 치명타와 정밀 피해에 면역. 물리적 효과를 차단하며, 힘으로 되어 있으므로 무형체 생물과 에테르적 생물도 차단합니다. 순간이동 효과는 통과 가능(벽이 보이지 않으므로 시각 효과도). 주문 랭크 이하의 효과에 면역. {{spell:Disintegrate}} 주문에 의해 자동 파괴됩니다.<br><strong>강화(+2):</strong> 벽의 HP가 20 증가합니다."
  },
  {
  ...
  },
  {
    ...
    "duration": "1분",
    "summary": "살아있는 불꽃으로 변합니다. 화염 면역, 정밀 피해 저항 10, 냉기 및 물 약점 5. 접촉하거나 비무장 공격을 받으면 3d6 화염 피해. 비무장 공격에 +1d4 화염 피해 추가. 화염 주문의 피해 주사위 +1개. 점화를 선천 캔트립으로 시전 가능. 시전 행동이 2에서 1로 줄어듭니다. 비행 속도 40피트. 호흡 불필요.강화(9랭크): ...",
    "desc": "<strong>지속 시간:</strong> 1분<br>살아있는 불꽃으로 변합니다. <strong>화염 면역, 정밀 피해 저항 10, 냉기 및 물 약점 5</strong>. 접촉하거나 비무장 공격을 받으면 <strong>3d6 화염 피해</strong>. 비무장 공격에 <strong>+1d4 화염 피해</strong> 추가. 화염 주문의 피해 주사위 +1개. 점화를 선천 캔트립으로 시전 가능. 시전 행동이 2에서 1로 줄어듭니다. <strong>비행 속도 40피트</strong>. 호흡 불필요.<br><strong>강화(9랭크):</strong> 접촉 피해 4d6, 비무장 +2d4 화염, 비행 속도 60피트."
  },
  {
  ...
  },
  {
    ...
    "target": "생물 1",
    "duration": "1분",
    "summary": "무시무시한 환영 외관을 만들어 관찰자를 겁먹게 합니다. 대상을 보는 적은 의지 내성 시도. 실패 시 공포 2. 대실패 시 공포 3+도주 1라운드.강화(8랭크): 30피트 폭발 내 모든 아군에 효과 적용 가능.",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>지속 시간:</strong> 1분<br>무시무시한 환영 외관을 만들어 관찰자를 겁먹게 합니다. 대상을 보는 적은 의지 내성 시도. 실패 시 <strong>{{condition:Frightened}} 2</strong>. 대실패 시 {{condition:Frightened}} 3+<strong>{{condition:Fleeing}} 1라운드</strong>.<br><strong>강화(8랭크):</strong> 30피트 폭발 내 모든 아군에 효과 적용 가능."
  },
  {
  ...
  },
  {
    ...
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 동의하는 살아있는 생물 1<br><strong>지속 시간:</strong> 1분<br>재생 15를 부여합니다. 대상은 HP 피해로 죽을 수 없으며, {{condition:Dying}} 상태가 {{condition:Dying}} 3을 초과하여 증가하지 않습니다. {{condition:Wounded}} 수치가 4 이상이면 의식을 잃은 채로 남습니다. 산성 또는 화염 피해를 받으면 재생이 다음 턴 이후까지 비활성화됩니다. 손상되거나 파괴된 기관이 재성장합니다. 절단된 부위는 상호작용 행동으로 다시 붙일 수 있습니다.<br><strong>강화(9랭크):</strong> 재생 20."
  },
  {
    "id": "retrocognition",
    "name_ko": "과거 인지",
  ...
  },
  {
    ...
    "area": "60피트 폭발",
    "defense": "반사",
    "summary": "모든 대상에 8d10 화염 피해, 언데드에 추가 8d10 활력 피해. 마법 어둠과 겹치면 어둠 효과를 상쇄 시도.대성공: 영향 없음. 성공: 절반 피해. 실패: 전체 피해. 대실패: 전체 피해 + 영구 실명.강화(+1): 화염 +1d10, 활력 +1d10.",
  ...
  },
  {
    ...
    "target": "생물 4",
    "duration": "다음 턴 시작까지",
    "summary": "생물 하나를 지정합니다. 지속 시간 동안 각 대상이 지정된 생물에 대해 처음 명중 굴림을 할 때 d20을 두 번 굴려 높은 것을 사용합니다. 또한 은폐/숨겨짐으로 인한 상황 페널티와 일반 판정을 무시합니다.",
    "desc": "<strong>사거리:</strong> 60피트<br><strong>대상:</strong> 생물 4<br><strong>지속 시간:</strong> 다음 턴 시작까지<br>생물 하나를 지정합니다. 지속 시간 동안 각 대상이 지정된 생물에 대해 처음 명중 굴림을 할 때 <strong>d20을 두 번 굴려 높은 것을 사용</strong>합니다. 또한 {{condition:Concealed}}/{{condition:Hidden}}으로 인한 상황 페널티와 일반 판정을 무시합니다."
  },
  {
    "id": "vision-of-death",
    "name_ko": "죽음의 환시",
    ...
    "desc": "<strong>사거리:</strong> 120피트<br><strong>대상:</strong> 살아있는 생물 1<br><strong>방어:</strong> 의지<br><strong>8d6 정신 피해</strong>. 0 HP로 감소하면 환시가 현실이 되어 즉사합니다.<br><strong>대성공:</strong> 영향 없음. <strong>성공:</strong> 절반 피해, {{condition:Frightened}} 1. <strong>실패:</strong> 전체 피해, {{condition:Frightened}} 2. <strong>대실패:</strong> 2배 피해, {{condition:Frightened}} 4, {{condition:Frightened}} 상태인 동안 도주.<br><strong>강화(+1):</strong> 피해 +2d6."
  },
  {
    ...
    "defense": "반사",
    "summary": "14d6 화염 피해. 바위에 갇힌 생물: 서투름 1, 이동 속도에 -10피트 상태 페널티. 5피트 이내 생물은 내성과 무관하게 강렬한 열기로 3d6 화염 피해. 비행 생물은 즉시 20피트 하강.대성공: 영향 없음. 성공: 절반 피해. 실패: 전체 피해, 바위에 갇힘. 대실패: 2배 피해, 바위에 갇힘.갇힌 생물은 주문 DC에 대해 탈출하...",
  ...
  },
  {
    ...
    "target": "생물 1",
    "defense": "의지",
    "summary": "정신 기능과 감각 입력을 뒤섞습니다. 결과와 무관하게 대상은 10분 일시적 면역.대성공: 영향 없음. 성공: 다음 턴 첫 행동을 혼란 상태로 소비. 실패: 1분 동안 혼란. 대실패: 영구 혼란.",
    "desc": "<strong>사거리:</strong> 120피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br>정신 기능과 감각 입력을 뒤섞습니다. 결과와 무관하게 대상은 10분 일시적 면역.<br><strong>대성공:</strong> 영향 없음. <strong>성공:</strong> 다음 턴 첫 행동을 {{condition:Confused}} 상태로 소비. <strong>실패:</strong> 1분 동안 {{condition:Confused}}. <strong>대실패:</strong> 영구 {{condition:Confused}}."
  },
  {
    "id": "arctic-rift",
    "name_ko": "극지 균열",
    ...
    "target": "생물 1",
    "defense": "기본 반사",
    "summary": "매서운 추위가 생물에 피해를 주고 얼립니다. 10d8 냉기 피해(기본 반사). 실패 시 둔화 2(1라운드). 대실패 시 석화(petrified, 얼음으로)(1분).강화(+1): 피해 +2d8.",
    "desc": "<strong>사거리:</strong> 120피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 기본 반사<br>매서운 추위가 생물에 피해를 주고 얼립니다. <strong>10d8 냉기 피해</strong>(기본 반사). 실패 시 <strong>{{condition:Slowed}} 2</strong>(1라운드). 대실패 시 <strong>{{condition:Petrified}}(petrified, 얼음으로)</strong>(1분).<br><strong>강화(+1):</strong> 피해 +2d8."
  },
  {
    ...
    "desc": "<strong>사거리:</strong> 120피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 다양<br>순수한 슬픔에서 증류된 선율. <strong>10d6 정신 피해</strong>. 저주받은 동안 상황/상태 보너스를 받을 수 없음.<br><strong>성공:</strong> 절반 피해, {{condition:Frightened}} 1, 저주 1라운드. <strong>실패:</strong> 전체 피해, {{condition:Frightened}} 2, 저주 1분. <strong>대실패:</strong> 2배 피해, {{condition:Frightened}} 3+도주 1라운드, 저주 10분."
  },
  {
    "id": "desiccate",
    "name_ko": "탈수",
    ...
    "target": "살아있는 생물 다수",
    "defense": "기본 인내",
    "summary": "살아있는 생물의 몸에서 수분을 격렬하게 빼앗습니다. 대상은 10d10 공허 피해를 받고 기본 인내 내성을 시도합니다. 물 특성이나 식물 특성을 가진 생물은 내성 결과가 한 단계 나빠집니다. 수분이 없는 생물(대지 정령 등)은 이 주문에 면역입니다.강화(+1): 피해 +1d10.",
    "desc": "<strong>사거리:</strong> 500피트<br><strong>대상:</strong> 살아있는 생물 다수<br><strong>방어:</strong> 기본 인내<br>살아있는 생물의 몸에서 수분을 격렬하게 빼앗습니다. 대상은 <strong>10d10 공허 피해</strong>를 받고 <strong>기본 인내 내성</strong>을 시도합니다. 물 특성이나 식물 특성을 가진 생물은 내성 결과가 <strong>한 단계 나빠집니다</strong>. 수분이 없는 생물(대지 정령 등)은 이 주문에 <strong>면역</strong>입니다.<br><strong>강화(+1):</strong> 피해 +1d10."
  },
  {
    "id": "disappearance",
    "name_ko": "소멸",
    ...
    "target": "생물 1",
    "duration": "10분",
    "summary": "생물을 모든 감각에서 숨깁니다. 대상이 미탐지 상태가 됩니다 — 시각뿐만 아니라 모든 정밀/부정확 감각에서. 탐색, 흩어진 먼지, 소리 공백 등으로 발견 가능.",
    "desc": "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 생물 1<br><strong>지속 시간:</strong> 10분<br>생물을 모든 감각에서 숨깁니다. 대상이 <strong>{{condition:Undetected}}</strong> 상태가 됩니다 — 시각뿐만 아니라 모든 정밀/부정확 감각에서. 탐색, 흩어진 먼지, 소리 공백 등으로 발견 가능."
  },
  {
  ...
  },
  {
    ...
    "defense": "의지",
    "duration": "다양",
    "summary": "대상은 무방비. 반응 사용 불가. 반보(Stride, 절반 속도) 외의 이동 행동 사용 불가.대성공: 영향 없음. 성공: 3라운드, 매 턴 최소 1행동을 춤에 사용. 실패: 1분, 매 턴 최소 2행동을 춤에 사용. 대실패: 1분, 매 턴 모든 행동을 춤에 사용.",
  ...
  },
  {
    ...
    "desc": "<strong>사거리:</strong> 100피트<br><strong>영역:</strong> 20피트 폭발<br><strong>대상:</strong> 추적할 생물/물체 1 + 최대 5 동의 생물<br><strong>지속 시간:</strong> 다양<br>투시 기반 완벽한 시야. 추적 대상 1을 선택하여 감지기로 삼습니다. 최대 5 동의 생물이 유령 같은 이미지를 볼 수 있습니다. {{condition:Concealed}}/{{condition:Invisible}} 상태를 감지할 수 있지만 물리적 장벽은 여전히 엄폐를 제공합니다. 추적 생물은 납이나 흐르는 물 외의 모든 장벽을 관통해 봅니다. 대상이 동의하면 지속 시간 1시간. 비동의 시 의지 내성."
  },
  {
    "id": "detonate-magic",
    "name_ko": "마법 폭발",
  ...
  },
  {
    ...
    "target": "생물 1",
    "duration": "1시간",
    "summary": "여섯 번째 감각이 대상에게 위험을 경고합니다. 자신에게 시전하면 정신 연결로 대상에게 알립니다. 대상은 우선권에 +2 상태 보너스를 받으며, 감지되지 않은 생물이나 측면 협공에 의해 무방비가 되지 않습니다. 반응: 적대적 생물이나 위험이 대상을 위협할 때, 예지가 대상을 방어합니다 — 대상이 두 번 굴려 높은 것을 사용합니다. 적대...",
  ...
  },
  {
    ...
    "duration": "1분",
    "summary": "변환 마법의 달인으로서 형태 속에 또 다른 형태를 숨깁니다. 주문 목록에 있거나 8랭크 이하로 준비 가능한 모든 변신형 주문이 부여하는 형태로 변신할 수 있습니다(8랭크 이하 상향된 버전 포함). 해당 형태에서 일반적으로 얻는 임시 HP 대신 임시 HP 40을 얻습니다.",
    "desc": "<strong>지속 시간:</strong> 1분<br>변환 마법의 달인으로서 형태 속에 또 다른 형태를 숨깁니다. 주문 목록에 있거나 8랭크 이하로 준비 가능한 모든 변신형 주문이 부여하는 형태로 변신할 수 있습니다(8랭크 이하 상향된 버전 포함). 해당 형태에서 일반적으로 얻는 임시 HP 대신 <strong>임시 HP 40</strong>을 얻습니다."
  },
  {
    ...
    "desc": "<strong>영역:</strong> 40피트 폭발<br><strong>방어:</strong> 의지<br>신의 위엄을 취합니다. 영역 내 적이 의지 내성 시도. 실패 시 <strong>매 턴 첫 행동을 절하기(엎드리기)에 사용</strong>해야 합니다(1분). 대실패 시 추가로 <strong>{{condition:Stunned}} 1</strong>."
  },
  {
    "id": "phantasmagoria",
    "name_ko": "환상 공포증",
    ...
    "desc": "<strong>사거리:</strong> 120피트<br><strong>영역:</strong> 30피트 폭발<br><strong>방어:</strong> 의지<br>겁먹게 하고 정신 피해를 주며 대상을 죽일 수도 있습니다. <strong>16d6 정신 피해</strong>. {{condition:Frightened}} 1(성공), {{condition:Frightened}} 2(실패), {{condition:Frightened}} 3+도주(대실패). 대실패 시 피해가 0 HP로 만들면 <strong>공포로 사망</strong>."
  },
  {
    "id": "seize-soul",
    "name_ko": "영혼 포획",
  ...
  },
  {
    ...
    "area": "40피트 발산",
    "defense": "인내",
    "summary": "8d10 공허 피해.대성공: 영향 없음. 성공: 전체 피해. 실패: 전체 피해, 소진 1d4. 대실패: 2배 피해, 소진 4.",
  ...
  },
  {
    ...
    "range": "30피트",
    "duration": "유지(최대 1분)",
    "summary": "영역 내 죽은 생물과 살아있는 생물에게 적용합니다. 살아있는 대상은 10d8+40 HP를 회복합니다. 죽은 대상은 부활과 같은 효과/제한으로 일시적으로 되살아나며, 부여된 HP와 동일한 임시 HP를 받습니다. 다른 방법으로 HP 회복이나 임시 HP 획득 불가. 부흥이 끝나면 모든 임시 HP를 잃고 사망합니다. 언데드나 붕괴/죽음 ...",
    "desc": "<strong>사거리:</strong> 30피트<br><strong>지속 시간:</strong> 유지(최대 1분)<br>영역 내 죽은 생물과 살아있는 생물에게 적용합니다. 살아있는 대상은 <strong>10d8+40 HP</strong>를 회복합니다. 죽은 대상은 부활과 같은 효과/제한으로 일시적으로 되살아나며, 부여된 HP와 동일한 임시 HP를 받습니다. 다른 방법으로 HP 회복이나 임시 HP 획득 불가. 부흥이 끝나면 모든 임시 HP를 잃고 사망합니다. 언데드나 붕괴/죽음 효과로 죽은 생물은 부활 불가."
  },
  {
