...
const HERITAGE_DB = [
  ...
  {id:'battle-ready-orc',name_ko:'전투 준비 오크',name_en:'Battle-Ready Orc',ancestry:'orc',summary:'두려운 전장 지휘관의 혈통입니다. <strong>위협(Intimidation)에 숙련</strong>되고, <strong>위협적 노려보기(Intimidating Glare)</strong> 기술 재주를 얻습니다.',grantSkills:['intimidation'],grantFeats:['intimidating-glare']},
  {id:'deep-orc',name_ko:'심연 오크',name_en:'Deep Orc',ancestry:'orc',summary:'굳은살이 박힌 손과 빨간 눈이 산악 동굴의 깊은 어둠에서 보낸 삶을 말해줍니다. 지하 지형에 대한 <strong>지형 전문가(Terrain Expertise)</strong> 기술 재주와 <strong>전투 등반가(Combat Climber)</strong> 기술 재주를 얻습니다.',grantFeats:[{id:'terrain-expertise',choice:'underground'},'combat-climber']},
  {id:'hold-scarred-orc',name_ko:'흉터 오크',name_en:'Hold-Scarred Orc',ancestry:'orc',summary:'의례적 흉터나 문신에 참여하는 오크 공동체의 일원입니다. 혈통에서 10 대신 <strong>12 HP</strong>를 얻습니다. <strong>불굴(Diehard)</strong> 재주도 얻습니다.',hpBonus:2,grantFeats:['diehard']},
