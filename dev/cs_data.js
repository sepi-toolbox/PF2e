...
const HERITAGE_DB = [
  {
    ...
    "ancestry": "dwarf",
    "summary": "옛 드워프 영웅들은 적의 마법을 떨쳐낼 수 있었고, 그 저항의 일부가 당신에게 나타납니다. <em>고대의 피에 호소</em> 반응을 얻습니다."
  },
  {
    ...
    "ancestry": "dwarf",
    "summary": "조상이 무덤 수호자였으며, 죽음을 물리치는 힘이 당신에게 전해졌습니다. 공허 특성이 있거나 언데드 생물이 만든 효과에 대한 내성 굴림에서 <strong>성공을 굴리면 대성공</strong>이 됩니다."
  },
  {
    "id": "forge-dwarf",
    "name_ko": "단조 드워프",
  ...
  },
  {
    ...
    "name_en": "Rock Dwarf",
    "ancestry": "dwarf",
    "summary": "조상이 산의 고대 돌 사이나 대지의 깊은 곳에서 살고 일했습니다. 이것은 발을 딛고 서면 바위처럼 단단하게 만듭니다. 재배치, 밀기, 넘어뜨리기 시도에 대한 인내 또는 반사 DC에 <strong>+2 상황 보너스</strong>를 얻습니다. 이 보너스는 이동시키거나 엎드리게 하려는 주문이나 효과에 대한 내성 굴림에도 적용됩니다.<br>추가로, 어떤 효과가 당신을 <strong>10피트 이상 강제 이동</strong>시키면, <strong>절반 거리만</strong> 이동합니다."
  },
  {
    ...
    "ancestry": "dwarf",
    "summary": "피가 강하고 건강하여 독소를 떨쳐낼 수 있습니다. 레벨 절반만큼의 독 저항(최소 1)을 얻고, 독 고통에 대한 성공적인 내성 굴림은 단계를 2만큼 감소시킵니다(맹독은 1). 독에 대한 대성공은 단계를 3만큼 감소시킵니다(맹독은 2).",
  ...
  },
  {
    ...
    "name_en": "Cavern Elf",
    "ancestry": "elf",
    "summary": "지하 터널이나 동굴에서 태어났거나 오랜 세월을 보냈으며, 빛이 부족한 곳입니다. <strong>암시야</strong>를 얻습니다.",
  ...
  },
  {
    ...
    "name_en": "Seer Elf",
    "ancestry": "elf",
    "summary": "마법 현상을 감지하고 이해하는 타고난 능력이 있습니다. 마법 탐지 캔트립을 비전 선천 주문으로 자유롭게 시전할 수 있습니다. 캔트립은 레벨 절반(올림)과 같은 주문 랭크로 고양됩니다. 추가로, 마법 식별 판정과 마법적 성질의 문서 해독 판정에 +1 상황 보너스를 얻습니다. 이 기술 행동은 일반적으로 주문학, 자연학, 오컬티즘, 종교 기술을 사용합니다.",
  ...
  },
  {
    ...
    "name_en": "Whisper Elf",
    "ancestry": "elf",
    "summary": "귀가 섬세하게 조율되어 가장 미세한 소리의 속삭임도 감지할 수 있습니다. 30피트 내의 숨겨진 또는 미탐지 생물을 찾기 위해 탐색 행동을 사용할 때 <strong>+2 상황 보너스</strong>를 얻습니다. 은폐된 대상이나 숨겨진 대상을 공격할 때, 단순 판정의 DC를 은폐는 <strong>3</strong>으로, 숨김은 <strong>9</strong>로 줄입니다. 이 혜택은 들을 수 없거나 대상이 소리를 낼 수 없는 경우(예: 침묵 주문의 영향)에는 적용되지 않습니다."
  },
  {
    "id": "woodland-elf",
    "name_ko": "삼림 엘프",
    ...
    "ancestry": "elf",
    "summary": "숲, 깊은 정글, 또는 유사한 환경에서의 삶에 적응하여 나무를 오르고 잎사귀를 활용하는 법을 알고 있습니다. 나무, 덩굴, 기타 식물을 오를 때, <strong>성공 시 절반 속도로, 대성공 시 전체 속도</strong>로 이동합니다(빠른 등반이 있으면 성공 시에도 전체 속도). 등반 속도가 있으면 영향받지 않습니다.<br>숲 지형 내에 있을 때, 장애물 뒤에 있지 않더라도 항상 <strong>엄폐 행동</strong>을 사용하여 엄폐를 얻을 수 있습니다."
  },
  {
    "id": "chameleon-gnome",
    "name_ko": "카멜레온 노움",
  ...
  },
  {
    ...
    "ancestry": "gnome",
    "summary": "페이의 피가 혈관을 흐르며, 마법으로 포화시켜 진정으로 그들 중 하나로 만듭니다. 노움과 인간형 특성에 더하여 페이 특성을 얻습니다. 원시 주문 목록에서 캔트립 1개를 선택합니다. 이 주문을 원시 선천 주문으로 자유롭게 시전할 수 있습니다. 캔트립은 레벨 절반(올림)과 같은 주문 랭크로 고양됩니다. 하루에 1회, 10분간의 명상(집중 특성 있는 활동)으로 첫 번째 세계와 재정렬하여 이 캔트립을 같은 목록의 다른 것으로 변경할 수 있습니다.",
  ...
  },
  {
    ...
    "ancestry": "gnome",
    "summary": "모든 색을 더 밝게, 모든 소리를 더 풍부하게, 특히 모든 냄새를 놀라운 세부 사항으로 느낍니다. 특수 감각을 얻습니다: <strong>30피트 범위의 부정확 후각</strong>. 이것은 후각으로 생물의 정확한 위치를 결정할 수 있다는 의미입니다(434페이지 설명). GM은 일반적으로 바람이 생물로부터 불어오면 범위를 두 배로, 생물로 불어가면 절반으로 합니다.<br>추가로, 후각 범위 내에서 미탐지 생물을 찾으려 할 때 지각 판정에 <strong>+2 상황 보너스</strong>를 얻습니다.",
  ...
  },
  {
    ...
    "ancestry": "gnome",
    "summary": "어둡거나 그림자의 페이와의 연결이든, 드라트넬라르로 알려진 지하 노움이든, 다른 원천이든, 완전한 어둠에서도 볼 수 있습니다. <strong>암시야</strong>를 얻습니다.",
  ...
  },
  {
    ...
    "ancestry": "goblin",
    "summary": "가족의 이빨은 무시무시한 무기입니다. <strong>1d6 관통 피해</strong>의 턱 비무장 공격을 얻습니다. 격투 그룹이며 기교와 비무장 특성을 가집니다.",
  ...
  },
  {
    ...
    "ancestry": "halfling",
    "summary": "가문은 위기 상황에서 냉정을 유지하고 공포를 떨쳐내는 것으로 알려져 있습니다. 감정 효과에 대한 내성에서 <strong>성공을 굴리면 대성공</strong>이 됩니다."
  },
  {
    "id": "hillock-halfling",
    "name_ko": "언덕 하플링",
  ...
  },
  {
    ...
    "ancestry": "halfling",
    "summary": "조상이 세대에 걸쳐 이곳저곳을 여행하며 정착하는 데 만족하지 않았습니다. 사용 가능한 일반/비일반 언어에서 <strong>추가 언어 2개</strong>를 얻고, 다국어 재주를 가질 때마다 <strong>추가 1개</strong>를 더 얻습니다.",
  ...
  },
  {
    ...
    "ancestry": "halfling",
    "summary": "조상이 해질녘의 은폐 속에서 많은 비밀스러운 행동을 했으며, 시간이 지나며 하플링의 일반적인 예리한 시야를 넘어 황혼에서도 볼 수 있는 능력을 발달시켰습니다. <strong>저광 시야</strong>를 얻습니다.",
  ...
  },
  {
    ...
    "ancestry": "leshy",
    "summary": "동굴과 나무 그늘에서 자라는 균류로 만들어졌으며, 어둠 동굴과 터널이 편합니다. <strong>암시야</strong>를 얻습니다. 식물 특성을 잃고 <strong>균류 특성</strong>을 얻습니다.",
  ...
  },
  {
    ...
    "ancestry": "orc",
    "summary": "태양에 타는 황무지 출신으로, 긴 다리와 요소를 견디는 능력이 번성에 도움이 되었습니다. 탐험 중 멈추기 전까지 <strong>급행을 두 배 오래</strong> 할 수 있고, 환경 열 효과를 한 단계 낮게 취급합니다."
  },
  {
    "id": "battle-ready-orc",
    "name_ko": "전투 준비 오크",
    ...
    "ancestry": "orc",
    "summary": "두려운 전장 지휘관의 혈통입니다. <strong>위협에 숙련</strong>되고, <strong>위협적 노려보기</strong> 기술 재주를 얻습니다.",
  ...
  },
  {
    ...
    "name_en": "Deep Orc",
    "ancestry": "orc",
    "summary": "굳은살이 박힌 손과 빨간 눈이 산악 동굴의 깊은 어둠에서 보낸 삶을 말해줍니다. 지하 지형에 대한 <strong>지형 전문가</strong> 기술 재주와 <strong>전투 등반가</strong> 기술 재주를 얻습니다.",
  ...
  },
  {
    ...
    "ancestry": "orc",
    "summary": "의례적 흉터나 문신에 참여하는 오크 공동체의 일원입니다. 혈통에서 10 대신 <strong>12 HP</strong>를 얻습니다. <strong>불굴</strong> 재주도 얻습니다.",
  ...
  },
  {
    ...
    "ancestry": "orc",
    "summary": "열대 우림에서 태어나 정글 지형을 민첩하게 이동하고 습한 환경의 질병에 저항합니다. 등반이나 수영 운동 판정에 <strong>+2 상황 보너스</strong>, 질병에 대한 내성에 <strong>+1 상황 보너스</strong>."
  },
  {
    "id": "changeling",
    "name_ko": "체인질링",
    "name_en": "Changeling",
    "ancestry": "*",
    "summary": "어머니가 해그입니다. 눈의 홍채이색증이 이 혈통의 가장 명확한 표시입니다.<br><br><b>체인질링 특성</b>을 얻습니다. <b>저광 시야</b>를 얻거나, 혈통이 이미 저광 시야가 있으면 <b>암시야</b>를 얻습니다. 혈통 재주를 얻을 때마다 체인질링 재주와 다른 부모 혈통의 재주에서 선택할 수 있습니다.",
  ...
  },
  {
    ...
    "name_en": "Nephilim",
    "ancestry": "*",
    "summary": "필멸자와 불멸 존재의 거래에서 태어난 차원 혈손. 다른 차원의 초자연적 정수를 물려받아 독특한 신체적 특징과 초세속적 힘으로 나타납니다. 천사, 악마, 주시자 등에게까지 유산을 추적할 수 있습니다.<br><br>천상체, 악마, 또는 주시자의 영향을 받은 본성. 황금 눈, 후광, 뿔, 꼬리 같은 특징의 조합. <b>네피림 특성</b>을 얻습니다. <b>저광 시야</b>를 얻거나, 혈통이 이미 저광 시야가 있으면 <b>암시야</b>를 얻습니다. 혈통 재주를 얻을 때마다 네피림 재주와 혈통 재주에서 선택 가능.",
  ...
  },
  {
    ...
    "ancestry": "*",
    "summary": "벨크젠의 오크가 속삭이는 폭군에 대한 전쟁의 핵심 선봉이 되면서, 다른 혈통의 동맹과 함께 싸우며, 오크 유산과 다른 혈통이 섞인 아이들이 늘었습니다. 이 \"하프오크\"들 중 많은 이가 자신을 \"드로마르\"라 칭하며, 이것은 무리를 전쟁으로 행군시키는 북을 치는 자를 가리키는 오크어입니다.<br><br>인간 부모가 있는 드로마르는 보통 약 70세까지 삽니다.<br><br>오크의 힘이 혈통에 힘을 줍니다. 피부가 녹색 빛을 띠고 오크 유산의 다른 표시가 있습니다. <b>오크 특성</b>, <b>드로마르 특성</b>, <b>저광 시야</b>를 얻습니다. 혈통 재주를 얻을 때 드로마르와 오크 재주에서도 선택 가능.",
...
const ACTION_DB = [
  ...
  },
  {
    ...
    "req_rank": 0,
    "req_feat": null,
    "summary": "<strong>특성:</strong> 공격<br>빈 손으로 적을 붙잡으려 합니다. 운동 판정을 적의 인내 DC에 대해 시도합니다. 대성공: 속박, 성공: 붙잡힘, 실패: 효과 없음, 대실패: 적이 당신을 붙잡거나 당신이 무방비."
  },
  {
    "id": "disarm",
    "cat": "skill",
  ...
  },
  {
    ...
    "req_rank": 0,
    "req_feat": null,
    "summary": "<strong>특성:</strong> 이동<br><br>좁거나 불안정한 표면 위를 이동합니다. 곡예 판정을 시도합니다. DC는 표면에 따라 달라집니다. 균형 잡기를 시도하는 동안 당신은 <strong>무방비</strong>입니다.<br><strong>대성공:</strong> 이동 속도까지 이동하며 지형을 험지로 취급합니다(일반적으로 절반 속도).<br>"
  },
  {
    "id": "tumble-through",
    "cat": "skill",
  ...
  },
  {
    ...
    "req_rank": 0,
    "req_feat": null,
    "summary": "<strong>특성:</strong> 비밀<br>엄폐나 상위 엄폐 뒤, 또는 은폐 상태에서 숨어 관측 대신 숨겨진 상태가 됩니다. GM이 은신 판정을 비밀리에 굴려 각 관찰자의 감지 DC와 비교합니다. 표준 엄폐 시 +2, 상위 엄폐 시 +4 상황 보너스.<br><strong>성공:</strong> 볼 수 있었던 생물에게 숨겨진 상태가 됩니다. 엄폐/은폐가 사라지면 다시 관측 상태. 숨기, 잠행, 한 걸음 외의 행동을 하면 관측 상태(타격 시 공격 전까지 무방비 유지)."
  },
  {
    "id": "sneak",
    "cat": "skill",
    ...
    "req_rank": 0,
    "req_feat": null,
    "summary": "<strong>특성:</strong> 이동, 비밀<br>탐지되지 않은 채 이동합니다. 절반 속도로 보폭합니다. 이동 종료 시 GM이 은신 판정을 비밀리에 굴려, 이동 시작 시 숨겨진/미탐지 상태였던 각 생물의 감지 DC와 비교합니다. 이동 중 엄폐/상위 엄폐가 있으면 보너스를 얻습니다.<br><strong>성공:</strong> 이동 중과 이동 후 미탐지 상태를 유지합니다. 숨기/잠행/한 걸음 외의 행동을 하면 관측 상태.<br>"
  },
  {
    "id": "lie",
    "cat": "skill",
  ...
  },
  {
    ...
    "req_rank": 0,
    "req_feat": null,
    "summary": "<strong>특성:</strong> 집중, 탐험, 조작<br>다른 사람이나 다른 것으로 위장합니다. 설득력 있는 변장을 만드는 데 10분과 변장 키트(288페이지)가 필요합니다. 생물은 보통 탐색 행동으로 당신의 기만 DC에 대해 지각 판정을 시도해야 당신을 간파합니다. 직접 상호작용하면 GM이 비밀 기만 판정을 굴립니다.<br><strong>성공:</strong> 변장한 인물로 속입니다. 행동이 변하면 새 판정이 필요할 수 있습니다.<br>"
  },
  {
    "id": "feint",
    "cat": "skill",
  ...
  },
  {
    ...
    "req_rank": 0,
    "req_feat": null,
    "summary": "<strong>특성:</strong> 정신<br>몸짓, 속임수, 또는 주의를 돌리는 말로 생물의 시선을 다른 곳으로 유도합니다. 기만 판정을 대상의 감지 DC에 대해 시도합니다. 성공 여부에 관계없이, 대상은 1분간 당신의 주의 분산 시도에 +4 상황 보너스를 얻습니다.<br><strong>성공:</strong> 감지 DC 이하인 생물에게 숨겨진 상태가 됩니다. 턴 종료까지 또는 한 걸음/은신 외 행동을 할 때까지 지속.<br>"
  },
  {
    "id": "make-impression",
    "cat": "skill",
  ...
  },
  {
    ...
    "req_rank": 0,
    "req_feat": null,
    "summary": "<strong>특성:</strong> 청각, 집중, 감정, 공포, 정신<br>갑작스러운 외침, 시의적절한 조롱, 또는 날카로운 비꼬기로 적의 결의를 흔듭니다. 30피트 내 인식하고 있는 생물 1명을 선택하여 그 대상의 의지 DC에 대해 위협 판정을 시도합니다. 대상이 당신의 언어를 이해하지 못하거나 언어를 사용하지 않으면 -4 상황 페널티. 결과에 관계없이, 대상은 10분간 당신의 사기 저하 시도에 면역.<br><strong>대성공:</strong> 대상이 공포 2.<br>"
  },
  {
    "id": "coerce",
    "cat": "skill",
  ...
  },
  {
    ...
    "req_rank": 2,
    "req_feat": null,
    "summary": "<strong>특성:</strong> 탐험, 치유, 조작<br><br>부상당한 살아있는 생물 1명을 10분간 치료합니다(자신도 가능). 대상은 1시간 동안 상처 치료에 면역입니다(치료 시간 포함). 의학 판정 DC는 보통 15이지만 GM이 조정 가능합니다. 전문가이면 DC 20으로 치유 +10, 달인이면 DC 30으로 +30, 전설이면 DC 40으로 +50.<br>1시간 동안 치료하면 회복량이 2배가 됩니다.<br><strong>대성공:</strong> 4d8 HP 회복 + 부상 상태 제거.<br>"
  },
  {
    "id": "treat-poison",
    "cat": "skill",
  ...
  },
  {
    ...
    "req_rank": 2,
    "req_feat": null,
    "summary": "<strong>특성:</strong> 조작<br><br>열쇠 없이 자물쇠를 엽니다. DC는 자물쇠의 복잡성과 제작 품질에 따라 결정됩니다. 더 높은 품질의 자물쇠는 여러 번의 성공이 필요할 수 있습니다.<br><strong>대성공:</strong> 자물쇠를 열거나 2회 성공 진행. 흔적 없음.<br><br>모든 종류의 경험과 훈련이 클래스에서 배우는 것 이상으로 캐릭터를 형성할 수 있습니다. 특정 혈통이나 클래스의 구성원뿐 아니라 누구나 — 어느 정도의 훈련으로 — 배울 수 있는 능력을 <span class=\"term\">일반 재주</span>라 합니다.<br>대부분의 클래스에서 3레벨부터 매 4레벨마다 일반 재주를 얻습니다. 일반 재주를 얻을 때마다, 전제조건을 충족하는 일반 특성의 재주를 선택할 수 있습니다.<br>일반 재주에는 <strong>기술 재주</strong>라는 하위 범주도 있으며, 이것은 기술로 할 수 있는 것을 확장합니다. 기술 재주에는 기술 특성도 있습니다. 대부분의 캐릭터는 2레벨부터 매 2레벨마다 기술 재주를 얻습니다. 기술 재주를 얻을 때는 기술 특성이 있는 일반 재주만 선택할 수 있으며, 기술 특성이 없는 일반 재주는 선택할 수 없습니다. 기술 재주의 레벨은 보통 캐릭터가 숙련도 전제조건을 충족할 수 있는 최소 레벨입니다.<br>각 기술에 특별히 관련된 기술 재주 외에도, 확인처럼 다양한 기술이나 모든 기술에 사용할 수 있는 재주가 있습니다."
  },
  {
    "id": "disable-device",
    "cat": "skill",
  ...
  },
  {
    ...
    "req_rank": 2,
    "req_feat": null,
    "summary": "<strong>특성:</strong> 휴식, 조작<br><br>아이템을 만듭니다. 아이템의 공식이 필요하며, 가격의 절반에 해당하는 원재료와 최소 2일의 작업이 필요합니다(공식이 있으면 1일). 제작 판정 후 추가 시간을 투자하여 남은 비용을 줄일 수 있습니다.<br><strong>대성공:</strong> 성공이며 추가 작업일의 비용 감소가 레벨+1에 기반.<br>"
  },
  {
    "id": "earn-income-cr",
    "cat": "skill",
  ...
  },
  {
    ...
    "req_rank": 0,
    "req_feat": "방패 막기",
    "summary": "방패 막기 일반 재주(262페이지)를 얻습니다."
  },
  {
    "id": "aoo",
    "cat": "feat",
  ...
  },
  {
    ...
    "req_rank": 0,
    "req_feat": "기습 공격",
    "summary": "무방비 상태인 생물에 민첩/기교 근접 무기, 민첩/기교 비무장 공격, 원거리 무기/비무장 공격으로 타격 시 <strong>추가 1d6 정밀 피해</strong>. 투척 근접 무기는 민첩/기교여야 합니다. 5, 11, 17레벨에 피해 주사위가 1개씩 증가."
  },
  {
    "id": "inspire-courage",
    "cat": "feat",
  ...
  },
  {
    ...
    "req_rank": 0,
    "req_feat": "사냥감 추적",
    "summary": "볼 수 있거나 추적 중인 생물 1명을 사냥감으로 지정합니다. 사냥감을 탐색할 때 지각 판정에 <strong>+2 상황 보너스</strong>, 추적할 때 생존 판정에 <strong>+2 상황 보너스</strong>. 사냥감에 대한 두 번째 사거리 증분 내 원거리 공격 페널티도 무시합니다. 한 번에 사냥감 1명만 가능. 다음 일일 준비까지 지속."
  },
  {
