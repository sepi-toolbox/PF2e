...
// 클래스 서브클래스 DB
const SUBCLASS_DB = []; // 서브클래스 = DataManager 단일소스(data/derived/subclasses.json). 런타임=PF2eClass.loadSubclasses()가 채움(구 큐레이션 하드코딩 폐기, v0.157). 큐레이션 원본=subclasses_curated.json.
...
const TRAIT_DB = [
  ...
  },
  {
    ...
    "name_en": "",
    "type": "damage",
    "desc": "지속 피해의 한 유형. 턴 종료 시 피해를 받고 DC 15 플랫 판정으로 종료 가능."
  },
  {
    "id": "빈사",
    "name_ko": "빈사",
  ...
  },
  {
    ...
    "name_en": "",
    "type": "weapon",
    "desc": "잘 보이지 않음. 공격 시 DC 5 플랫 판정 필요."
  },
  {
    "id": "혼란",
    "name_ko": "혼란",
  ...
  },
  {
    ...
    "name_en": "",
    "type": "weapon",
    "desc": "청각 상실. 청각 기반 지각에 자동 대실패. 주문시전 시 DC 5 플랫 판정."
  },
  {
    "id": "운명",
    "name_ko": "운명",
  ...
  },
  {
    ...
    "name_en": "",
    "type": "weapon",
    "desc": "위치는 알지만 볼 수 없음. 대상 지정 시 DC 11 플랫 판정."
  },
  {
    "id": "이동 불가",
    "name_ko": "이동 불가",
  ...
  },
  {
    ...
    "name_en": "",
    "type": "weapon",
    "desc": "이동 불가 + 무방비 + 조작에 DC 5 플랫 판정. 탈출로 빠져나옴."
  },
  {
    "id": "메스꺼움",
    "name_ko": "메스꺼움",
  ...
  },
  {
    ...
    "name_en": "",
    "type": "weapon",
    "desc": "정신 기반 판정/DC에 페널티 = 수치. 주문시전 시 DC 5+수치 플랫 판정(실패 시 소실)."
  },
  {
    "id": "무의식",
    "name_ko": "무의식",
  ...
  },
  {
    ...
    "name_en": "cobbled",
    "type": "mechanic",
    "desc": "이 총기는 서로 엉켜 있어서 불발될 가능성이 높습니다. 아무리 잘 유지하더라도 명중 굴림이 실패하면 공격이 실패해 평탄 DC 5를 굴려야 합니다. 이 판정에 실패하면 무기가 제대로 발사되지 않습니다."
  },
  {
    "id": "coda",
    "name_ko": "코다",
  ...
  },
  {
    ...
    "name_en": "disarm",
    "type": "mechanic",
    "desc": "이 무기는 한 손이 없어도 운동 기술로 무장 해제할 수 있습니다. 이 경우 무기의 사거리(자신의 사거리와 다른 경우)를 사용하며, 무기의 아이템 보너스가 있는 경우 명중 굴림에 대한 아이템 보너스를 운동 판정에 아이템 보너스로 추가합니다. 무기를 사용하여 무장 해제 판정에서 대실패하면, 무기를 떨어뜨려 대실패 대신 실패의 효과를 받을 수 있습니다. 대성공을 거둔 경우에도 아이템을 획득하려면 한 손이 자유로워야 합니다."
  },
  {
    "id": "div",
    "name_ko": "디브",
  ...
  },
  {
    ...
    "name_en": "grapple",
    "type": "mechanic",
    "desc": "이 무기를 사용하면 양손이 자유롭지 않아도 운동 기술로 격투할 수 있습니다. 이 경우 무기의 사정거리(자신의 사정거리와 다른 경우)를 사용하며, 무기의 아이템 보너스를 운동 기술 판정에 아이템 보너스로 추가하여 명중 굴림에 추가합니다. 무기를 사용하여 격투 판정에서 대실패하면 무기를 떨어뜨려 대실패 대신 실패의 효과를 받을 수 있습니다."
  },
  {
    "id": "gremlin",
    "name_ko": "그렘린",
  ...
  },
  {
    ...
    "name_en": "shove",
    "type": "mechanic",
    "desc": "이 무기는 양손이 자유롭지 않아도 운동 기술로 밀기 기술을 사용할 수 있습니다. 이 경우 무기의 사정거리(자신의 사정거리와 다른 경우)를 사용하며, 무기의 아이템 보너스를 운동 기술 판정에 아이템 보너스로 추가하여 명중 굴림에 추가합니다. 무기를 사용하여 밀치기 판정에서 대실패하면 무기를 떨어뜨려 대실패 대신 실패의 효과를 받을 수 있습니다."
  },
  {
    "id": "skeleton",
    "name_ko": "스켈레톤",
  ...
  },
  {
    ...
    "name_en": "training",
    "type": "mechanic",
    "desc": "훈련 무기는 동물이 공격할 대상을 식별하여 전투에 참여하도록 훈련시킬 때 사용합니다. 훈련 무기로 생물을 공격하면 동반자 또는 반려 동물이 해당 대상에 대한 다음 명중 굴림에 +1 상황 보너스를 받습니다."
  },
  {
    "id": "transcendence",
    "name_ko": "초월",
...
// 상태이상 카탈로그 = data/derived/conditions.json 단일소스(DataManager 편집 가능, 하드코딩 폐기). name(한글)=저장 키 불변.
//   표시·조회용(페널티 수학은 state.conditions 값 별도) → cs_ui _loadConditions 로더가 채우고 buildConditions·활성표시 재렌더.
var CONDITIONS_DATA = [];   // var = 전역 객체 속성(cross-file 재할당 확실: cs_ui _loadConditions가 채움)
