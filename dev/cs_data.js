...
//  VISION ENUM (v526~)
// ═══════════════════════════════════════════════
const VISION_TYPES = ['none','low-light','darkvision','greater-darkvision'];
const VISION_KO = {'none':'없음','low-light':'저광 시야','darkvision':'암시야','greater-darkvision':'상위 암시야'};
const VISION_EN = {'none':'','low-light':'Low-Light Vision','darkvision':'Darkvision','greater-darkvision':'Greater Darkvision'};
