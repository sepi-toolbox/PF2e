...
const PER_SHEET = {
  ...
  EFFECT_GROUPS: {
    ...
    type:            '효과 타입 enum: hp_bonus, save_bonus, ac_bonus, speed_bonus, initiative_bonus, skill_bonus, skill_trained, grant_action, grant_focus_spell, grant_innate_spell, grant_feat, grant_feat_if_trained, grant_lore, grant_weapon, grant_adopted_feat, weapon_familiarity, weapon_trained, vision_upgrade, extra_sense, resistance, proficiency, cantrip_slots, spell_slots, dying_threshold, recovery_dc, familiar_abilities, speed_extra, bulk_bonus, unburdened_iron, martial_experience, adopted_ancestry, armor_upgrade, [v534~ heritage] rest_bonus_hp, extra_languages, versatile_ancestry, extra_feat_category ... (display_note/damage_note는 FEAT_DB.auto_note/damage_note로 흡수됨)',
    target:          '식별자 통합 컬럼 — type별 의미: skill_trained=skill id / grant_feat=재주 id / grant_focus_spell|grant_innate_spell=주문명 / grant_action=action id / grant_weapon=무기명 / grant_lore=지식 분야 / vision_upgrade=시야 enum (darkvision/low-light/upgrade) / extra_sense=감각 텍스트(별도 sense 컬럼 사용 가능) / save_bonus=fort/ref/will/all / resistance=피해종류(한글) / weapon_familiarity|weapon_trained=무기명(행 펼침) / proficiency=DOM id suffix / extra_feat_category=재주 카테고리/혈통명',
    value:           '수치 값 (hp_bonus/save_bonus/speed_bonus/ac_bonus/bulk_bonus/cantrip_slots/dying_threshold/initiative_bonus/recovery_dc/speed_extra/spell_slots/familiar_abilities). 또는 "level" 키워드',
