...
const PER_SHEET = {
  ...
  EFFECT_GROUPS: {
    ...
    target:          '식별자 통합 컬럼 — type별 의미: skill_trained=skill id / grant_feat=재주명 / grant_focus_spell|grant_innate_spell=주문명 / grant_action=action id / grant_weapon=무기명 / grant_lore=지식 분야 / vision_upgrade=시야 enum / extra_sense=감각 / save_bonus=fort/ref/will/all / resistance=피해종류 / weapon_familiarity|weapon_trained=무기명(행 펼침) / proficiency=DOM id suffix',
