...
const BACKGROUNDS = [
  ...
  {id:'farmhand', name:'농부', en:'Farmhand', boosts:'건강 또는 지혜, 자유', skills:'운동, 농업 지식', feat:'운동 확인', desc:'강한 등과 계절 순환에 대한 이해로 땅을 갈고 작물을 돌봤습니다. 침략자가 농장을 불태웠거나, 가족을 잃었거나, 단조로움에 질렸을 수 있습니다. 속성 부스트: 건강 또는 지혜, 자유 | 기술: 운동, 농업 지식 | 기술 특기: 운동 확인'},
  ...
  {id:'martial-disciple', name:'무예 수련생', en:'Martial Disciple', boosts:'근력 또는 민첩, 자유', skills:'곡예 또는 운동, 전쟁 지식', feat:'고양이 착지/빠른 점프', desc:'위대한 전사가 되기 위해 강도 높은 훈련과 엄격한 학습에 헌신했습니다. 전통적 수도원, 엘리트 군사 학교, 또는 유명 용병 조직의 지부에서 배웠을 수 있습니다. 속성 부스트: 근력 또는 민첩, 자유 | 기술: 곡예 또는 운동 중 선택, 전쟁 지식 | 기술 특기: 곡예 선택 시 고양이 착지, 운동 선택 시 빠른 점프'},
  ...
  {id:'miner', name:'광부', en:'Miner', boosts:'근력 또는 지혜, 자유', skills:'생존, 광업 지식', feat:'지하 지형 전문가', desc:'빛 없는 대지의 깊은 곳에서 귀중한 광물을 뜯어내어 생계를 유지했습니다. 속성 부스트: 근력 또는 지혜, 자유 | 기술: 생존, 광업 지식 | 기술 특기: 지하 지형 전문가'},
  {id:'noble', name:'귀족', en:'Noble', boosts:'지능 또는 매력, 자유', skills:'사회, 족보 지식', feat:'궁정 예절', desc:'평민에게 귀족의 삶은 목가적 사치로 보이지만, 귀족이나 야심 찬 신사로 자라면서 현실을 알게 됩니다: 귀족의 운명은 의무와 음모입니다. 속성 부스트: 지능 또는 매력, 자유 | 기술: 사회, 족보 지식 또는 문장학 지식 | 기술 특기: 궁정 예절'},
  {id:'nomad', name:'유목민', en:'Nomad', boosts:'건강 또는 지혜, 자유', skills:'생존, 지형 지식', feat:'생존 확인', desc:'멀리 넓게 여행하며 도로와 미지의 땅에서 살아남는 기본 전술을 배웠습니다. 속성 부스트: 건강 또는 지혜, 자유 | 기술: 생존, 지형 지식 | 기술 특기: 생존 확인'},
  ...
  {id:'raised-by-belief', name:'신앙에 의해 양육됨', en:'Raised by Belief', boosts:'신격 속성 중 하나, 자유', skills:'신격 기술, 신격 지식', feat:'기술 확인', desc:'수도원, 종교적 가정, 또는 일상생활의 일부로, 특정 신격(35페이지)의 전통에 깊이 젖은 양육을 받았습니다. 속성 부스트: 신격의 신성 속성 중 하나, 자유 | 기술: 신격의 신성 기술, 신격 관련 지식 | 기술 특기: 해당 기술의 확인'},
  ...
  {id:'scholar', name:'학자', en:'Scholar', boosts:'지능 또는 지혜, 자유', skills:'주문학/자연학/오컬티즘/종교학 중 선택, 학술원 지식', feat:'기술 확인', desc:'배우는 재능이 있어 바깥 세계에서 격리되어 할 수 있는 모든 것을 배웠습니다. 책에서 많은 경이로운 장소와 사물을 읽었고, 결국 호기심이 모험가가 되게 했습니다. 속성 부스트: 지능 또는 지혜, 자유 | 기술: 신비학/자연학/비학/종교 중 선택, 학술원 지식 | 기술 특기: 선택한 기술의 확인'},
  ...
  {id:'teacher', name:'교사', en:'Teacher', boosts:'지능 또는 지혜, 자유', skills:'공연 또는 사회, 학술원 지식', feat:'숙련된 전문가', desc:'놀라울 정도로 지식이 풍부하고, 아이와 어른에게 세계와 경이에 대해 가르치는 데 숙련되고 훈련까지 받았을 수 있습니다. 속성 부스트: 지능 또는 지혜, 자유 | 기술: 공연 또는 사회 중 선택, 학술원 지식 | 기술 특기: 숙련된 전문가'},
