...
const HERITAGE_DB = [
  ...
  {id:'nephilim',name_ko:'네피림',name_en:'Nephilim',ancestry:'*',versatile:true,
   summary:'필멸자와 불멸 존재의 거래에서 태어난 차원 혈손(planar scions). 다른 차원의 초자연적 정수를 물려받아 독특한 신체적 특징과 초세속적 힘으로 나타납니다. 천사, 마귀, 감시자 등에게까지 유산을 추적할 수 있습니다.<br><br>천상, 마귀, 또는 감시자의 영향을 받은 본성. 황금 눈, 후광, 뿔, 꼬리 같은 특징의 조합. <b>네피림(nephilim) 특성</b>을 얻습니다. <b>저광 시야</b>를 얻거나, 혈통이 이미 저광 시야가 있으면 <b>암시야</b>를 얻습니다. 혈통 재주를 얻을 때마다 네피림 재주와 혈통 재주에서 선택 가능.'},
