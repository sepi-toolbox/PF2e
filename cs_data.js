...
const HERITAGE_DB = [
  ...
  {id:'fey-touched-gnome',name_ko:'페이혈 노움',name_en:'Fey-Touched Gnome',ancestry:'gnome',summary:'페이의 피가 혈관을 흐르며, 마법으로 포화시켜 진정으로 그들 중 하나로 만듭니다. 노움과 인간형 특성에 더하여 페이(fey) 특성을 얻습니다. 근원(Primal) 주문 목록에서 캔트립 1개를 선택합니다. 이 주문을 근원 선천 주문으로 자유롭게 시전할 수 있습니다. 캔트립은 레벨 절반(올림)과 같은 주문 랭크로 고양됩니다. 하루에 1회, 10분간의 명상(집중 특성 있는 활동)으로 첫 번째 세계와 재정렬하여 이 캔트립을 같은 목록의 다른 것으로 변경할 수 있습니다.'},
