...
const TRAIT_DB = [
  ...
  },
  {
    ...
    "name_en": "incorporeal",
    "type": "mechanic",
    "desc": "무형의 생명체 또는 물체는 물리적 형태가 없습니다. 벽을 포함한 단단한 물체를 통과할 수 있습니다. 물체 안에 있는 무형 생물은 물체 외부를 인식하거나 공격하거나 상호작용할 수 없으며, 물체 안에서 자신의 차례를 시작하면 1만큼 둔화됩니다. 무형 생물은 무형 생물을 통과할 수 있지만 그 공간에서 자신의 이동을 끝낼 수는 없습니다. 무형 생물은 물체가 유령 접촉 속성 룬을 가지고 있지 않는 한, 물리 생물이나 물체에 대해 근력 기반 체크를 시도할 수 없으며 무형 생물에 대해서만 시도할 수 있습니다. 마찬가지로, 육체 생명체는 무체 생명체나 물체에 대해 근력 기반 체크를 시도할 수 없습니다. 무형 생명체는 일반적으로 질병, 독, 정밀 피해와 같이 물리적인 몸을 필요로 하는 효과나 조건에 면역이 있습니다. 일반적으로 모든 피해(역장 피해와 유령 접촉 속성 룬이 있는 공격으로 인한 피해 제외)에 대한 저항이 있으며, 비마법 피해에 대한 저항은 두 배로 증가합니다."
  },
  {
    "id": "inevitable",
    "name_ko": "불가피한",
