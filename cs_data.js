...
const HERITAGE_DB = [
  ...
  {id:'sensate-gnome',name_ko:'감각 노움',name_en:'Sensate Gnome',ancestry:'gnome',summary:'모든 색을 더 밝게, 모든 소리를 더 풍부하게, 특히 모든 냄새를 놀라운 세부 사항으로 느낍니다. 특수 감각을 얻습니다: <strong>30피트 범위의 부정확 후각(imprecise scent)</strong>. 이것은 후각으로 생물의 정확한 위치를 결정할 수 있다는 의미입니다(434페이지 설명). GM은 일반적으로 바람이 생물로부터 불어오면 범위를 두 배로, 생물로 불어가면 절반으로 합니다.<br>추가로, 후각 범위 내에서 미탐지(undetected) 생물을 찾으려 할 때 감지 판정에 <strong>+2 상황 보너스</strong>를 얻습니다.'},
