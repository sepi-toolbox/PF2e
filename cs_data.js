...
const BACKGROUNDS = [
  ...
  {id:'scholar', name:'학자', en:'Scholar', boosts:'지능 또는 지혜, 자유', skills:'주문학/자연학/오컬티즘/종교학 중 선택, 학술원 지식', feat:'확인', desc:'배우는 재능이 있어 바깥 세계에서 격리되어 할 수 있는 모든 것을 배웠습니다. 책에서 많은 경이로운 장소와 사물을 읽었고, 결국 호기심이 모험가가 되게 했습니다. 속성 부스트: 지능 또는 지혜, 자유 | 기술: 주문학/자연학/비학/종교 중 선택, 학술원 지식 | 기술 특기: 선택한 기술의 확인'},
