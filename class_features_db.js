...
var CLASS_FEATURE_NAMES = {
  ...
  cleric: [
    ...
    {lv:5, name_ko:'지각 전문가', name_en:'Alertness'},
  ...
  druid: [
    ...
    {lv:3, name_ko:'지각 전문가', name_en:'Alertness'},
  ...
  ranger: [
    ...
    {lv:7, name_ko:'지각 달인', name_en:'Perception Master'},
    {lv:7, name_ko:'무기 전문화', name_en:'Weapon Specialization'},
  ...
  witch: [
    ...
    {lv:11, name_ko:'지각 전문가', name_en:'Alertness'},
