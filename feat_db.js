...
,
  {name_ko:"자동 지식", name_en:"Automatic Knowledge", feat_level:2, prerequisites:"지식 회상 행동에 전문가, 해당 기술에 확인(Assurance)", traits:["일반 기술"], category:"skill", summary:"라운드당 1회, 자유 행동으로 지식 회상을 사용할 수 있습니다. 이때 확인의 결과를 사용해야 합니다.", desc:'<strong>전제조건:</strong> 지식 회상 행동에 전문가, 해당 기술에 확인(Assurance)<br>라운드당 1회, <strong>자유 행동으로 지식 회상</strong>을 사용할 수 있습니다. 이때 확인의 결과를 사용해야 합니다.<br><strong>특수:</strong> 여러 번 선택 가능. 매번 다른 기술(전문가 이상이고 확인이 있어야).' }
,
